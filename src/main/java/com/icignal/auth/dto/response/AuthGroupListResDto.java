...
public class AuthGroupListResDto  implements Serializable {
	...
	private List<AuthDataResDto> authDataList;		//권한데이터 목록
	...
	public List<AuthDataResDto> getAuthDataList() {
		return authDataList;
	}

	public void setAuthDataList(List<AuthDataResDto> authDataList) {

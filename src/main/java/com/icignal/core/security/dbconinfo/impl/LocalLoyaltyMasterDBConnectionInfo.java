...
public class LocalLoyaltyMasterDBConnectionInfo extends DBConnectionInfo {

	public static final String ENV_PATH = "icignal.db-connection-info.local.loy-db.master";

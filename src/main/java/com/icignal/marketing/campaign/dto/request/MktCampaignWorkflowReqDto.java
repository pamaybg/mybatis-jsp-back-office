 ...
 */
public class MktCampaignWorkflowReqDto extends MKTBaseReqDto {
    ...
    private List<MktCampaignWorkflowNodeDataReqDto> nodeList;    //node 목록
    ...
    public List<MktCampaignWorkflowNodeDataReqDto> getNodeList() {
        return nodeList;
    }

    public void setNodeList(List<MktCampaignWorkflowNodeDataReqDto> nodeList) {

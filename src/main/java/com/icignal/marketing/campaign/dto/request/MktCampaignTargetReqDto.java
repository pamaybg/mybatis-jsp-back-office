...
public class MktCampaignTargetReqDto extends CommonDataAuthReqDto {
	...
	private String ctrlGroupId;
	private String tgtGroupNo;
	
	private String channelCode;
	private List<String> memberIdList;
	private List<MktCampaignTargetDtlReqDto> campaignTargetDtlList;
    ...
    public List<MktCampaignTargetDtlReqDto> getCampaignTargetDtlList() {
        return campaignTargetDtlList;
    }

    public void setCampaignTargetDtlList(List<MktCampaignTargetDtlReqDto> campaignTargetDtlList) {

...
public class MktCampaignResourceReqDto extends MKTBaseReqDto {
    ...
    private List<MktCampaignResourceReqDto> resourceList;    //자원 목록 
    ...
    public List<MktCampaignResourceReqDto> getResourceList() {
    ...
    public void setResourceList(List<MktCampaignResourceReqDto> resourceList) {

...
public class MktCampaignExecutionInfoItemListResDto extends GridPagingItemResDto {
    ...
    private List<MktCampaignROIReturnListResDto> exeResponseCountList;    //실행반응수 목록
    ...
    public List<MktCampaignROIReturnListResDto> getExeResponseCountList() {
        return exeResponseCountList;
    }

    public void setExeResponseCountList(List<MktCampaignROIReturnListResDto> exeResponseCountList) {

...
public class MktCampaignExecutionInfoResDto extends GridPagingItemResDto {
    ...
    private List<MktCampaignExecutionInfoItemListResDto> executionInfoItemList;
    ...
    public List<MktCampaignExecutionInfoItemListResDto> getExecutionInfoItemList() {
        return executionInfoItemList;
    }

    public void setExecutionInfoItemList(List<MktCampaignExecutionInfoItemListResDto> executionInfoItemList) {

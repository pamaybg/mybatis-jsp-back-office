...
public class MktCampaignExecutionInfoReqDto extends MKTBaseReqDto {
    ...
    private List<MktCampaignExecutionInfoItemReqDto> executionInfoItemList;
    ...
    public List<MktCampaignExecutionInfoItemReqDto> getExecutionInfoItemList() {
        return executionInfoItemList;
    }

    public void setExecutionInfoItemList(List<MktCampaignExecutionInfoItemReqDto> executionInfoItemList) {

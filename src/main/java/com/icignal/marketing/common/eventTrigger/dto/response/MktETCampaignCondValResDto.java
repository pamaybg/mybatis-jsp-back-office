...
/**
 * @name : ICNETCampaignCondValListResponseDTO.java
 * @date : 2016. 11. 16
 * @author : dg.ryu
 * @description : 캠페인 조건값 목록
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class MktETCampaignCondValResDto extends StatusResDto {
	...
	private String lgcCompNm;			 //로지컬 컴포넌트명
	private String fieldDpNm;			 //필드명
	...
	public String getFieldDpNm() {
		return fieldDpNm;
	}

	public void setFieldDpNm(String fieldDpNm) {
		this.fieldDpNm = fieldDpNm;
	}

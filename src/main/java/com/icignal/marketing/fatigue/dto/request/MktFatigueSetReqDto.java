 ...
 * @description : 피로도 추가
 */
public class MktFatigueSetReqDto extends CommonDataAuthReqDto {
	...
	private int fatiRestrictionDay; // 피로도 기한(일)
	private int fatiMaxRestrictionDayCnt; //피로도 최대 제한 횟수(일)
	...
	public int getFatiRestrictionDay() {
		return fatiRestrictionDay;
	}

	public void setFatiRestrictionDay(int fatiRestrictionDay) {
		this.fatiRestrictionDay = fatiRestrictionDay;
	}

	public int getFatiMaxRestrictionDayCnt() {
		return fatiMaxRestrictionDayCnt;
	}

	public void setFatiMaxRestrictionDayCnt(int fatiMaxRestrictionDayCnt) {

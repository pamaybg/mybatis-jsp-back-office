 ...
 */
public class MktContentReqDto extends CommonDataAuthReqDto {
    
	private String id;                       //아이디
	private String contentsName;             //콘텐츠명
	private String brazeCamApiKey;			 //캠페인 키
    ...
    private String ridOfr;      //오퍼 rid
    
    private String contsTypeCd; // 컨텐츠 유형
	private String userDiv;
    
	//kakao 알림톡
	private List<MktContentKaKaoReqDto> kakaoConts;

	private String toCallbackNo;	// 송신자번호

	private String ridSurv; //설문 rid
	private String comOfrType; //오퍼유형: 쿠폰,난수형쿠폰,포인트,설문
	private String kakaoTypeCd; //카카오 알림톡/카카오 친구톡 구분 코드

	private String empType;	//본사&매장
	private String authType; //권한
	private String brdCd;	//브랜드 코드
	
    public List<MktContentKaKaoReqDto> getKakaoConts() {
		return kakaoConts;
	}
	public void setKakaoConts(List<MktContentKaKaoReqDto> kakaoConts) {
		this.kakaoConts = kakaoConts;
	}
	...
	public String getBrazeCamApiKey() {return brazeCamApiKey;}
	public void setBrazeCamApiKey(String brazeCamApiKey) {this.brazeCamApiKey = brazeCamApiKey;}

	public String getKakaoTypeCd() {
		return kakaoTypeCd;
	}

	public void setKakaoTypeCd(String kakaoTypeCd) {
		this.kakaoTypeCd = kakaoTypeCd;
	}
	...
	public String getBrdCd() {return brdCd;}

	public void setBrdCd(String brdCd) {this.brdCd = brdCd;}

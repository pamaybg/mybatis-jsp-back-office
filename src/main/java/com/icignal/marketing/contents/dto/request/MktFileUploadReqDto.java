...
/**
 * @name : AccountFileUploadRequestDTO 
 * @date : 2015. 05. 07.
 * @author : 홍성호
 */ 
@JsonIgnoreProperties(ignoreUnknown = true)
public class MktFileUploadReqDto extends MKTBaseReqDto{
    private String id;
    ...
    private List<MktFileUploadReqDto> array;
	...
	private List<MktFileUploadReqDto> selectedItems;
	public String getId() {
		return id;
	}
	...
	public List<MktFileUploadReqDto> getArray() {
		return array;
	}
	public void setArray(List<MktFileUploadReqDto> array) {
		this.array = array;
	}
	...
	public List<MktFileUploadReqDto> getSelectedItems() {
		return selectedItems;
	}
	public void setSelectedItems(List<MktFileUploadReqDto> selectedItems) {

 ...
 */
public class MktContentResDto extends GridPagingItemResDto {
    ...
    private String rid;
    private String ofrNm;        //쿠폰명

    private String ridOfr;

    private String contsTypeCd; //컨텐츠 유형 구분
    ...
    private String surveyNm; //설문 이름

    private String contentsChannelNM;
    ...
    public String getContentsChannelNM() {
        return contentsChannelNM;
    }

    public void setContentsChannelNM(String contentsChannelNM) {
        this.contentsChannelNM = contentsChannelNM;
    }

...
@CommCode
public class CouponResDto extends GridPagingItemResDto {
    ...
    @MarkName(groupCode = "LOY_CPN_CALL_METHOD_TYPE", codeField = "callMethod")
    private String callMethodNm;
	...
	public String getCallMethodNm() {
		return callMethodNm;
	}
	public void setCallMethodNm(String callMethodNm) {
		this.callMethodNm = callMethodNm;
	}

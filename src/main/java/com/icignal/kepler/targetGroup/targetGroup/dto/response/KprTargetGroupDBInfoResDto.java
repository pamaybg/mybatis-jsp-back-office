 ...
 * @date : 2016. 6. 10.
 * @author : 류동균
 * @description : 타겟그룹 DB 정보 ResponseDTO
 */
public class KprTargetGroupDBInfoResDto extends GridPagingItemResDto {
	...
	private String lgcSql;		//LC SQL
	private String segKeyCol;	//세그먼트 Key 컬럼
	private String segKeyColAlias;	//세그먼트 Key 컬럼 Alias
	...
	public String getSegKeyCol() {
		return segKeyCol;
	}

	public void setSegKeyCol(String segKeyCol) {
		this.segKeyCol = segKeyCol;
	}

	public String getSegKeyColAlias() {
		return segKeyColAlias;
	}

	public void setSegKeyColAlias(String segKeyColAlias) {
		this.segKeyColAlias = segKeyColAlias;
	}

 ...
 */
public class KprSegmentFilterResDto extends CommonDataAuthReqDto {
    ...
    private String filterSqlCount;      //필터SQL COUNT
    ...
    private String segFilterRelId;      //세그먼트 필터 관계 아이디
    private String childFilterId;       //하위 세그먼트 필터 아이디 
    private String segmentId;
    private String firstFlag;       //첫번째 여부
    private String lgcSql;			//로지컬컴포넌트 SQL
    private String tblAliasColNm;	//컬럼명
    private String custDtDef;		//사용자날짜정의
    private String parSegFilterId;	//상위필터아이디
    private String parSegFilterSql;	//상위필터SQL
	...
	public String getCustDtDef() {
		return custDtDef;
	}

	public void setCustDtDef(String custDtDef) {
		this.custDtDef = custDtDef;
	}
	...
	public String getParSegFilterId() {
		return parSegFilterId;
	}

	public void setParSegFilterId(String parSegFilterId) {
		this.parSegFilterId = parSegFilterId;
	}
	...
	public String getParSegFilterSql() {
		return parSegFilterSql;
	}

	public void setParSegFilterSql(String parSegFilterSql) {
		this.parSegFilterSql = parSegFilterSql;
	}

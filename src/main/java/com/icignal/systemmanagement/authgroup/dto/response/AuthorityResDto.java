...
import com.icignal.systemmanagement.authgroup.dto.request.AuthorityReqDto;
...
public class AuthorityResDto  implements Serializable {
	...
	public void setDefaultValue(AuthorityReqDto ar) {
		this.ridUser = ar.getRidUser();			//사용자 아이디
		this.empId = ar.getEmpId();				//직원 아이디
		this.authGroupId = ar.getAuthGroupId();	//권한그룹아이디
		this.dataTypeCd = ar.getDataTypeCd();		//데이터유형코드
		this.ridDivision = ar.getRidDivision();	//부서아이디
	}

...
/*
 * 1. 클래스명	: SystemOrganizationListResDto
 * 2. 파일명	: SystemOrganizationListResDto.java
 ...
 */ 
@CommCode
public class SystemOrganizationListResDto extends GridPagingItemResDto {
	
	private String rid;
	@MarkName(codeField = "divTypeCd", groupCode = "COM_DIVISION_TYPE_CD")
	private String divTypeCd;
	private String divNo;
	private String divNm;
	private String divLvl;
	private String ridParDiv;
	@MarkName(codeField = "divStatus", groupCode = "ACCOUNT_STATUS")

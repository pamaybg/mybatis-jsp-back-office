...
public class SystemPartnerInsertReqDto extends  CommonCondReqDto {
	...
	private List<MultiUploadReqDto> detailImages;
	...
	public List<MultiUploadReqDto> getDetailImages() {
		return detailImages;
	}
	public void setDetailImages(List<MultiUploadReqDto> detailImages) {
		this.detailImages = detailImages;
	}

	public IMAGE_UPLOAD_TYPE getEventBannerSubImageCategory () {
		IMAGE_UPLOAD_TYPE category = null;
		if(ObjectUtil.isNotEmpty(this.detailImages)) {
			this.detailImages.get(0).getCategory();
			/*for (MultiUploadReqDto mur : this.detailImages) {
	...
	public IMAGE_UPLOAD_TYPE getSubImageCategory () {
			...
			if(ObjectUtil.isNotEmpty(this.subImages)) {
				this.subImages.get(0).getCategory();

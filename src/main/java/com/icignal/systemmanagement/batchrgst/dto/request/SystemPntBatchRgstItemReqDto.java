...
/**
* @name : infavor.Loyalty.batchRgst.dto.request.SystemPntBatchRgstItemReqDto
* @date : 2018. 11. 5.
* @author : hy.jun
* @description :
*/
...
public class SystemPntBatchRgstItemReqDto extends CommonDataAuthReqDto {
	private String rid;
	...
	public String getPntTxnCode() {
		return pntTxnCode;
	}

	public void setPntTxnCode(String pntTxnCode) {
		this.pntTxnCode = pntTxnCode;
	}
	...
	public SystemPntBatchRgstItemReqDto() throws Exception {

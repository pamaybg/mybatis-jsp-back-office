...
@CommCode
public class SystemPntBatchRgstListResDto extends GridPagingItemResDto {
	private String rid;
	...
	@MarkName(groupCode="PNT_TXN_DTL_TYPE",codeField="procDtlTypeCd")
	private String procDtlTypeCdNm;
	...
	public String getProcDtlTypeCdNm() {
		return procDtlTypeCdNm;
	}
	public void setProcDtlTypeCdNm(String procDtlTypeCdNm) {
		this.procDtlTypeCdNm = procDtlTypeCdNm;
	}

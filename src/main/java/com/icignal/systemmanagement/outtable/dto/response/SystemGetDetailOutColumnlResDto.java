...
/*
 * 1. 클래스명	: SystemGetDetailOutColumnlResDto
 * 2. 파일명	: SystemGetDetailOutColumnlResDto.java
 ...
 */ 
@CommCode
public class SystemGetDetailOutColumnlResDto extends GridPagingItemResDto {

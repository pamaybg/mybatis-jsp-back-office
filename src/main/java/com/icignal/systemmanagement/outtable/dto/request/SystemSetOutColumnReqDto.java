...
/*
 * 1. 클래스명	: SystemSetOutColumnReqDto
 * 2. 파일명	: SystemSetOutColumnReqDto.java
 ...
 * </PRE>
 */ 
public class SystemSetOutColumnReqDto extends MKTGridPagingReqDto {
	...
	private String commType;			 //commcode 타입

 ...
 *
 */
public class LoggableStatementUtil implements PreparedStatement { 
	...
	public LoggableStatementUtil(Connection connection, String sql)
		throws SQLException {
	...
	public void setBoolean(int parameterIndex, boolean x)
		...
		if(x) {
			saveQueryParamValue(parameterIndex, Boolean.TRUE);
		} else {
			saveQueryParamValue(parameterIndex, Boolean.FALSE);
		}
	...
	/*
	 * 1. 메소드명: getParameterMetaData
	 * 2. 클래스명: PreparedStatement
	 * 3. 작성자명: knlee
	 * 4. 작성일자: 2020. 4. 10.
	 */
	/**

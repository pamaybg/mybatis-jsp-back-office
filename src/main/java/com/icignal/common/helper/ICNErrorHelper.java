...
public class ICNErrorHelper {
	...
	/* Loyalty 에러 코드 정의 시작   by knlee*/


	///////////  공통  시작  /////////////

	/**
	 * <b>MSG_RequriedVal</b> : 정상<br>
	 */
	public final static int MSG_LoyApi_Success = 0 ;  //정상

	/**
	 * <b>MSG_RequriedVal</b> : 필수값 오류<br>
	 */
	public final static int MSG_LoyApi_ReqVal_ERROR = 100 ;  //필수값 오류

	/**
	 * <b>MSG_LoyApi_DocType_ERROR</b> : 전문유형 오류<br>
	 */
	public final static int MSG_LoyApi_DocType_ERROR = 101;

	/**
	 * <b>MSG_LoyApi_Code_ERROR</b> : 코드 오류<br>
	 */
	public final static int MSG_LoyApi_Code_ERROR = 102;

	/**
	 * <b>MSG_LoyApi_Data_ERROR</b> : 데이터 오류<br>
	 */
	public final static int MSG_LoyApi_Data_ERROR = 103;

	/**
	 * <b>MSG_LoyApi_DataLength_ERROR</b> : 데이터 길이 오류<br>
	 */
	public final static int MSG_LoyApi_DataLength_ERROR = 104;
	
	/**
	 * <b>MSG_LoyApi_DB_ERROR</b> : DB 오류 <br>
	 */
	public final static int MSG_LoyApi_DB_ERROR = 105;
	
	/**
	 * <b>MSG_LoyApi_ETC_ERROR</b> : 기타 오류 <br>
	 */
	public final static int MSG_LoyApi_ETC_ERROR = 999;
	...
	/**
	 * <b>MSG_LoyApi_Card_Loss</b> : 분실카드 <br>
	 */
	public final static int MSG_LoyApi_Card_Loss = 200 ;

	/**
	 * <b>MSG_LoyApi_Card_Close</b> : 카드해지 <br>
	 */
	public final static int MSG_LoyApi_Card_Close = 201 ;

	/**
	 * <b>MSG_LoyApi_Mbr_Cert_Fail</b> :  회원 인증 실패 <br>
	 */
	public final static int MSG_LoyApi_Mbr_Cert_Fail = 202 ;

	/**
	 * <b>MSG_LoyApi_Mbr_Leave</b> : 탈회 회원 <br>
	 */
	public final static int MSG_LoyApi_Mbr_Leave = 203 ;

	/**
	 * <b>MSG_LoyApi_Mbr_NonReg</b> : 미등록 고객 <br>
	 */
	public final static int MSG_LoyApi_Mbr_NonReg = 204 ;


	/**
	 * <b>MSG_LoyApi_Mbr_Cert_No</b> : 미인증 회원 <br>
	 */
	public final static int MSG_LoyApi_Mbr_Cert_No = 205 ;


	/**
	 * <b>MSG_LoyApi_CertTypeCode_Error</b> : 인증유형 코드오류 <br>
	 */
	public final static int MSG_LoyApi_CertTypeCode_Error = 206;


	/**
	 * <b>MSG_LoyApi_PgmNo_Error</b> : 멤버십 프로그램 번호 오류 <br>
	 */
	public final static int MSG_LoyApi_PgmNo_Error = 207;


	/**
	 * <b>MSG_LoyApi_Card_Exist</b> : 기발급된 카드 번호<br>
	 */
	public final static int MSG_LoyApi_Card_Exist = 208;
	
	
	/**
	 * <b>MSG_LoyApi_Mbr_Exist</b> : 인증 회원 기존재<br>
	 */
	public final static int MSG_LoyApi_Mbr_Cert_Exist = 209;

	/**
	 * <b>MSG_LoyApi_Mbr_NoCert_Exist</b> : 미인증 회원 기존재<br>
	 */
	public final static int MSG_LoyApi_Mbr_NoCert_Exist = 210;
	
	/**
	 * <b>MSG_LoyApi_Mbr_ID_Dup</b> : 아이디 중복<br>
	 */
	public final static int MSG_LoyApi_Mbr_ID_Dup = 211;


	/**
	 * <b>MSG_OFFER_DUPL_ERROR</b> : 오퍼 번호 조회 오류  <br>
	 */
	public final static int MSG_OFFER_DUPL_ERROR = 212;
	
	/**
	 * <b>MSG_LoyApi_CardNo_CreateError</b> : 카드번호생성오류<br>
	 */
	public final static int MSG_LoyApi_CardNo_CreateError = 213;	
	
	/**
	 * <b>MSG_LoyApi_Tier_CreateError</b> : 등급생성오류<br>
	 */
	public final static int MSG_LoyApi_Tier_CreateError = 214;
	
	/**
	 * <b>MSG_LoyApi_Cust_DtaDupl_Exist</b> :  고객 데이터 중복 오류 (2건이상)<br>
	 */
	public final static int MSG_LoyApi_Cust_DtaDupl_Exist = 215;
	
	
	/**
	 * <b>MSG_LoyApi_Mbr_DtaDupl_Exist</b> :  회원 데이터 중복 오류 (2건이상)<br>
	 */
	public final static int MSG_LoyApi_Mbr_DtaDupl_Exist = 216;
	...
	///////////  채널   시작  /////////////
	/**
	 * <b>MSG_LoyApi_ChnlNo_ERROR</b> : 채널번호 오류 <br>
	 */
	public final static int MSG_LoyApi_ChnlNo_ERROR = 300;

	/**
	 * <b>MSG_LoyApi_Chnl_STOP</b> : 중지 가맹점 <br>
	 */
	public final static int MSG_LoyApi_Chnl_STOP = 301;

	/**
	 * <b>MSG_LoyApi_Chnl_Month_Over</b> : 가맹점 월 발생 한도 초과 <br>
	 */
	public final static int MSG_LoyApi_Chnl_Month_Over = 302;

	/**
	 * <b>MSG_LoyApi_Chnl_No_Acrl</b> : 적립 불가능 가맹점 <br>
	 */
	public final static int MSG_LoyApi_Chnl_No_Acrl = 303;

	/**
	 * <b>MSG_LoyApi_Chnl_No_Use</b> : 사용 불가능 가맹점 <br>
	 */
	public final static int MSG_LoyApi_Chnl_No_Use = 304;


	/**
	 * <b>MSG_LoyApi_Chnl_No_Use</b> : 비활성 가맹점 <br>
	 */
	public final static int MSG_LoyApi_Chnl_No_Active = 305;


	/**
	 * <b>MSG_LoyApi_Chnl_No_Use</b> : 가입불가능 가맹점 <br>
	 */
	public final static int MSG_LoyApi_Chnl_No_Join = 306;

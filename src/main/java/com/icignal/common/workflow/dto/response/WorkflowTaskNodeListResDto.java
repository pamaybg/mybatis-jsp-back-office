 ...
 * @description : 
 */
public class WorkflowTaskNodeListResDto extends StatusResDto {
    ...
    private String taskNodeName;    // 테스크 노드명
    ...
    private String shapeTypeCode;    //쉐잉프유형
    private String shapeTypeName;    //쉐잉프유형
    
    private String nodeType;    //노드유형
    private String nodeTypeCode;    //노드유형코드
    private String nodeTypeName;    //노드유형명

    private String nodeName;    //쉐이프명
    
    private String htmlTemplateId;    //HTML템플릿아이디
    ...
    List<WorkflowHandleListResDto> handleList;    //핸들목록

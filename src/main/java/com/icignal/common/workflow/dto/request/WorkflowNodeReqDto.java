 ...
 * @description : 
 */
public class WorkflowNodeReqDto extends CommonDataAuthReqDto {
    ...
    private List<WorkflowHandleReqDto> handleList;    //핸들 목록
    ...
    public List<WorkflowHandleReqDto> getHandleList() {
        return handleList;
    }

    public void setHandleList(List<WorkflowHandleReqDto> handleList) {

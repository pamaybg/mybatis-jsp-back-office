 ...
 * @description : 
 */
public class WorkflowTaskResDto extends StatusResDto {
    ...
    private List<WorkflowTaskNodeListResDto> nodeList;    //노드목록
    
    private List<WorkflowTaskConnectorListResDto> connectorList;    //커넥터목록
    ...
    public List<WorkflowTaskNodeListResDto> getNodeList() {
        return nodeList;
    }

    public void setNodeList(List<WorkflowTaskNodeListResDto> nodeList) {
        this.nodeList = nodeList;
    }

    public List<WorkflowTaskConnectorListResDto> getConnectorList() {
        return connectorList;
    }

    public void setConnectorList(List<WorkflowTaskConnectorListResDto> connectorList) {

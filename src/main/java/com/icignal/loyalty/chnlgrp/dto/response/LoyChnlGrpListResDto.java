 ...
 * 1. FileName	: LoyChnlGrpListResDto.java
 * 2. Package	: com.icignal.loyalty.chnlgrp.dto.response
 * 3. Comments	:	
 * 4. Author	: iticd
 * 5. DateTime	: 2020. 7. 14. 오후 5:05:02
 * 6. History	:
 * -----------------------------------------------------------------
 *	Date		 |	Name			|	Comment
 * -------------  -----------------   ------------------------------
...
/*
 * 1. 클래스명	: LoyChnlGrpListResDto
 * 2. 파일명	: LoyChnlGrpListResDto.java
 ...
 */
@CommCode
public class LoyChnlGrpListResDto extends GridPagingItemResDto{
	private String rid;

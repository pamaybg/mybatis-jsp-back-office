 ...
 * 1. FileName	: LoyChnlGrpResDto.java
 * 2. Package	: com.icignal.loyalty.chnlgrp.dto.response
 * 3. Comments	:	
 * 4. Author	: jh.seo
 * 5. DateTime	: 2020. 12. 28. 오후 3:09:31
 * 6. History	:
 * -----------------------------------------------------------------
 *	Date		 |	Name			|	Comment
 * -------------  -----------------   ------------------------------
...
/*
 * 1. 클래스명	: LoyChnlGrpResDto
 * 2. 파일명	: LoyChnlGrpResDto.java
...
public class LoyChnlGrpResDto extends StatusResDto{
	private String rid;

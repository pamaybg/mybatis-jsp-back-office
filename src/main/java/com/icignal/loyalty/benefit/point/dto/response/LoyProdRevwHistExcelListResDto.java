 ...
 * 1. FileName	: LoyProdRevwHistExcelListResDto.java
 * 2. Package	: com.icignal.loyalty.benefit.point.dto.response
 * 3. Comments	:	
 * 4. Author	: jh.seo
 * 5. DateTime	: 2021. 7. 6. 오후 2:21:16
 * 6. History	:
 * -----------------------------------------------------------------
 *	Date		 |	Name			|	Comment
 * -------------  -----------------   ------------------------------
...
/*
 * 1. 클래스명	: LoyProdRevwHistExcelListResDto
 * 2. 파일명	: LoyProdRevwHistExcelListResDto.java
...
@CommCode
//@PersonalData
public class LoyProdRevwHistExcelListResDto extends GridPagingItemResDto{

...
/**
* @name : infavor.Loyalty.common.dto.request.LoyPointAcrlRequestDTO
* @date : 2018. 11. 28.
* @author : hy.jun
* @description : 포인트 적립요청
*/
public class LoyPointAcrlRequestDTO extends MKTBaseReqDto {
	private int isConTran; //에러 발생 시 트랜잭션처리여부 (1:rollback, 0:commit)
...
//		encryptKey = CryptoManager.getCipherKey();
	...
	public int getApplyPnt() {
		return applyPnt;
	}
	public void setApplyPnt(int applyPnt) {

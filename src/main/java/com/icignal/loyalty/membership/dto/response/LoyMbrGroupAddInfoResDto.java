...
@CommCode
public class LoyMbrGroupAddInfoResDto {
	...
	@MarkName(groupCode="PARTNER_BL_TYPE", codeField="fraudDiv")
	private String fraudDivMarkName         ;
	private String fraudMbrbsActnDiv        ;
	@MarkName(groupCode="PARTNER_BL_RESULT", codeField="fraudMbrbsActnDiv")

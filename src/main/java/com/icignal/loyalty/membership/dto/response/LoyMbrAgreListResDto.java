 ...
 * 1. FileName	: LoyMbrAgreListResDto.java
 * 2. Package	: com.icignal.loyalty.membership.dto.response
 * 3. Comments	:	
 * 4. Author	: iticd
 * 5. DateTime	: 2020. 6. 15. 오후 3:52:58
 * 6. History	:
 * -----------------------------------------------------------------
 *	Date		 |	Name			|	Comment
 * -------------  -----------------   ------------------------------
 * 2020. 6. 15.		 | iticd			|	최초작성
 * -----------------------------------------------------------------
...
/*
 * 1. 클래스명	: LoyMbrAgreListResDto
 * 2. 파일명	: LoyMbrAgreListResDto.java
 ...
 */
@CommCode
public class LoyMbrAgreListResDto extends GridPagingItemResDto{
	private String rid;

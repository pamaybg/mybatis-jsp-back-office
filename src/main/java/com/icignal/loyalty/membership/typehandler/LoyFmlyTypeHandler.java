...
/*
 * 1. 클래스명	: LoyFmlyTypeHandler
 * 2. 파일명	: LoyFmlyTypeHandler.java
 ...
 * <PRE>
 * 1. 설명
 *		family 신규 가입 TypeHandler
 * </PRE>
 */ 
@SuppressWarnings({ "unchecked", "deprecation", "rawtypes" })
public class LoyFmlyTypeHandler implements TypeHandler<Object>{
	...
	public void setParameter(PreparedStatement ps, int i, Object parameter, JdbcType jdbcType) throws SQLException {
		...
		try {
				...
				StructDescriptor structDescriptor = new StructDescriptor("TY_FMLY",spyConn.getRealConnection());
		        ...
		        ArrayDescriptor desc = ArrayDescriptor.createDescriptor("TY_FMLY_TBL",spyConn.getRealConnection());
		        Array array = new ARRAY(desc,spyConn.getRealConnection(), structs);
		        ps.setArray(i, array);
		        
		}catch (Exception e) {
			LogUtil.error("LoyFmlyTypeHandler 오류",e);
		} finally {
			spyConn.close();
		}

...
/*
 * 1. 클래스명	: LoyCustAddTypeHandler
 * 2. 파일명	: LoyCustAddTypeHandler.java
...
public class LoyCustAddTypeHandler implements TypeHandler<Object>{
	...
	public void setParameter(PreparedStatement ps, int i, Object parameter, JdbcType jdbcType) throws SQLException {
		...
		try {
				...
				StructDescriptor structDescriptor = new StructDescriptor("T_CUST_ADD",spyConn.getRealConnection());
		        ...
		        ArrayDescriptor desc = ArrayDescriptor.createDescriptor("T_CUST_ADD_TBL",spyConn.getRealConnection());

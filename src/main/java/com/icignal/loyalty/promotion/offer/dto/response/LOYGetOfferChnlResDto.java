...
@CommCode
public class LOYGetOfferChnlResDto extends GridPagingItemResDto {
	...
	/**
	 * @return the chnlTypeSubNm
	 */
	public String getChnlTypeSubNm() {
		return chnlTypeSubNm;
	}
	/**
	 * @param chnlTypeSubNm the chnlTypeSubNm to set
	 */
	public void setChnlTypeSubNm(String chnlTypeSubNm) {
		this.chnlTypeSubNm = chnlTypeSubNm;
	}
	/**
	 * @return the chnlStatNm
	 */
	public String getChnlStatNm() {
		return chnlStatNm;
	}
	/**
	 * @param chnlStatNm the chnlStatNm to set
	 */
	public void setChnlStatNm(String chnlStatNm) {
		this.chnlStatNm = chnlStatNm;
	}

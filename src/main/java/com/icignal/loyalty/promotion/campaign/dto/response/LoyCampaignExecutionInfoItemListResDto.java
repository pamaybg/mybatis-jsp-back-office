...
public class LoyCampaignExecutionInfoItemListResDto extends GridPagingItemResDto{
    ...
    private List<LoyCampaignROIReturnListResDto> exeResponseCountList;    //실행반응수 목록
    ...
    public List<LoyCampaignROIReturnListResDto> getExeResponseCountList() {
        return exeResponseCountList;
    }

    public void setExeResponseCountList(List<LoyCampaignROIReturnListResDto> exeResponseCountList) {

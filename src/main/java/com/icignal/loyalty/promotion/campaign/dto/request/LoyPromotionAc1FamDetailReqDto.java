 ...
 * 1. FileName	: LoyPromotionAc1FamDetailReqDto.java
 * 2. Package	: com.icignal.loyalty.promotion.campaign.dto.request
 * 3. Comments	:	
 * 4. Author	: iticd
 * 5. DateTime	: 2020. 7. 3. 오전 3:28:28
 * 6. History	:
 * -----------------------------------------------------------------
 *	Date		 |	Name			|	Comment
 * -------------  -----------------   ------------------------------
...
/*
 * 1. 클래스명	: LoyPromotionAc1FamDetailReqDto
 * 2. 파일명	: LoyPromotionAc1FamDetailReqDto.java
...
public class LoyPromotionAc1FamDetailReqDto extends CommonDataAuthReqDto{
	private String rid;

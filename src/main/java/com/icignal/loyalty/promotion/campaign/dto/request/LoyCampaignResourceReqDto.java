...
public class LoyCampaignResourceReqDto extends CommonDataAuthReqDto {
    ...
    private List<LoyCampaignResourceReqDto> resourceList;    //자원 목록 
    ...
    public List<LoyCampaignResourceReqDto> getResourceList() {
    ...
    public void setResourceList(List<LoyCampaignResourceReqDto> resourceList) {

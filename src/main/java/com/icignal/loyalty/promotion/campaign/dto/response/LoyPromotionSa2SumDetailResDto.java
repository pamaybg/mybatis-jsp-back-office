 ...
 * 1. FileName	: LoyPromotionSa2SumDetailResDto.java
 * 2. Package	: com.icignal.loyalty.promotion.campaign.dto.response
 * 3. Comments	:	
 * 4. Author	: iticd
 * 5. DateTime	: 2020. 7. 2. 오후 7:36:35
 * 6. History	:
 * -----------------------------------------------------------------
 *	Date		 |	Name			|	Comment
 * -------------  -----------------   ------------------------------
...
/*
 * 1. 클래스명	: LoyPromotionSa2SumDetailResDto
 * 2. 파일명	: LoyPromotionSa2SumDetailResDto.java
...
public class LoyPromotionSa2SumDetailResDto extends StatusResDto{
	private String rid;

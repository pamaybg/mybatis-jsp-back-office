 ...
 * @description : 
 */
public class CampaignWorkflowStatusListResDto extends StatusResDto {
    ...
    private CampaignWorkflowDataResDto data;
    ...
    public CampaignWorkflowDataResDto getData() {
        return data;
    }

    public void setData(CampaignWorkflowDataResDto data) {
        this.data = data;
    }

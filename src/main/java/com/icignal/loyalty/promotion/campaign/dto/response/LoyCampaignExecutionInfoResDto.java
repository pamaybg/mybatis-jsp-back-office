...
public class LoyCampaignExecutionInfoResDto extends GridPagingItemResDto {
    ...
    private List<LoyCampaignExecutionInfoItemListResDto> executionInfoItemList;
    ...
    public List<LoyCampaignExecutionInfoItemListResDto> getExecutionInfoItemList() {
        return executionInfoItemList;
    }

    public void setExecutionInfoItemList(List<LoyCampaignExecutionInfoItemListResDto> executionInfoItemList) {

 ...
 * 1. FileName	: LoyPromotionAc2ConDetailReqDto.java
 * 2. Package	: com.icignal.loyalty.promotion.campaign.dto.response
 * 3. Comments	:	
 * 4. Author	: iticd
 * 5. DateTime	: 2020. 7. 2. 오전 10:42:58
 * 6. History	:
 * -----------------------------------------------------------------
 *	Date		 |	Name			|	Comment
 * -------------  -----------------   ------------------------------
...
/*
 * 1. 클래스명	: LoyPromotionAc2ConDetailReqDto
 * 2. 파일명	: LoyPromotionAc2ConDetailReqDto.java
...
public class LoyPromotionAc2ConDetailReqDto extends CommonDataAuthReqDto{
	private String rid;

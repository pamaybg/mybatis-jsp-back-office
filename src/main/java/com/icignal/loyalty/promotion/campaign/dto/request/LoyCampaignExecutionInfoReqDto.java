...
public class LoyCampaignExecutionInfoReqDto extends CommonDataAuthReqDto {
    ...
    private List<LoyCampaignExecutionInfoItemReqDto> executionInfoItemList;
    ...
    public List<LoyCampaignExecutionInfoItemReqDto> getExecutionInfoItemList() {
        return executionInfoItemList;
    }

    public void setExecutionInfoItemList(List<LoyCampaignExecutionInfoItemReqDto> executionInfoItemList) {

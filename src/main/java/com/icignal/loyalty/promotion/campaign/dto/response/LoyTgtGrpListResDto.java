 ...
 * 1. FileName	: LoyTgtGrpListResDto.java
 * 2. Package	: com.icignal.loyalty.promotion.campaign.dto.response
 * 3. Comments	:	
 * 4. Author	: iticd
 * 5. DateTime	: 2020. 6. 24. 오후 5:46:35
 * 6. History	:
 * -----------------------------------------------------------------
 *	Date		 |	Name			|	Comment
 * -------------  -----------------   ------------------------------
...
/*
 * 1. 클래스명	: LoyTgtGrpListResDto
 * 2. 파일명	: LoyTgtGrpListResDto.java
 ...
 */
@CommCode
public class LoyTgtGrpListResDto extends GridPagingItemResDto{
	private String rid;

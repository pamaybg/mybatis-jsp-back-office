 ...
 * 1. FileName	: LoyPromotionAc1ClbDetailReqDto.java
 * 2. Package	: com.icignal.loyalty.promotion.campaign.dto.request
 * 3. Comments	:	
 * 4. Author	: iticd
 * 5. DateTime	: 2020. 7. 3. 오전 4:35:03
 * 6. History	:
 * -----------------------------------------------------------------
 *	Date		 |	Name			|	Comment
 * -------------  -----------------   ------------------------------
...
/*
 * 1. 클래스명	: LoyPromotionAc1ClbDetailReqDto
 * 2. 파일명	: LoyPromotionAc1ClbDetailReqDto.java
...
public class LoyPromotionAc1ClbDetailReqDto extends CommonDataAuthReqDto{
	private String rid;

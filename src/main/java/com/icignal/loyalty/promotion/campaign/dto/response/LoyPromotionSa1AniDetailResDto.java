 ...
 * 1. FileName	: LoyPromotionSa1AniDetailResDto.java
 * 2. Package	: com.icignal.loyalty.promotion.campaign.dto.response
 * 3. Comments	:	
 * 4. Author	: iticd
 * 5. DateTime	: 2020. 7. 2. 오전 9:47:17
 * 6. History	:
 * -----------------------------------------------------------------
 *	Date		 |	Name			|	Comment
 * -------------  -----------------   ------------------------------
...
/*
 * 1. 클래스명	: LoyPromotionSa1AniDetailResDto
 * 2. 파일명	: LoyPromotionSa1AniDetailResDto.java
...
public class LoyPromotionSa1AniDetailResDto extends StatusResDto{
	private String rid;

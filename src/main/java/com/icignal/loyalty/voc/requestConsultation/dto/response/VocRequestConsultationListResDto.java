...
/**
 * @name : infavor.voc.requestConsultation.dto.response.VOCRequestConsultationListResponseDTO
 * @date : 2017. 10. 13.
 * @author : "dg.ryu"
 * @description : 상담요청 목록 Response DTO
 */
@PersonalData
@CommCode
public class VocRequestConsultationListResDto extends GridPagingItemResDto {
	...
	private String rcpMethCd;
	@MarkName(groupCode="CALL_TYPE", codeField="rcpMethCd")
	...
	private String cnslgTypeCdLCd;
	@MarkName(groupCode="SR_AREA_L", codeField="cnslgTypeCdLCd")
	private String cnslgTypeCdLNm;
	
	private String cnslgTypeCdMCd;
	@MarkName(groupCode="SR_AREA_M", codeField="cnslgTypeCdMCd")
	private String cnslgTypeCdMNm;
	
	private String cnslgTypeCdSCd;
	@MarkName(groupCode="SR_AREA_S", codeField="cnslgTypeCdSCd")
	private String cnslgTypeCdSNm;
	
	private String srTrtStatusCd;	
	@MarkName(groupCode="SR_STATUS", codeField="srTrtStatusCd")
	...
	private String writer; // 담당자(아이디형값임 ex: hjkim4)
	private String mbrIntCode;
	private String ridIntMbr;
	
	
	public String getRidIntMbr() {
		return ridIntMbr;
	}
	public void setRidIntMbr(String ridIntMbr) {
		this.ridIntMbr = ridIntMbr;
	}
	...
	public String getUnMaskCntcDesk() {
		return unMaskCntcDesk;
	}

	public void setUnMaskCntcDesk(String unMaskCntcDesk) {
		this.unMaskCntcDesk = unMaskCntcDesk;
	}
	...
	public String getSrTrtStatusCd() {
		return srTrtStatusCd;
	}

	public void setSrTrtStatusCd(String srTrtStatusCd) {
		this.srTrtStatusCd = srTrtStatusCd;
	}

	public String getCnslgTypeCdLCd() {
		return cnslgTypeCdLCd;
	}

	public void setCnslgTypeCdLCd(String cnslgTypeCdLCd) {
		this.cnslgTypeCdLCd = cnslgTypeCdLCd;
	}

	public String getCnslgTypeCdMCd() {
		return cnslgTypeCdMCd;
	}

	public void setCnslgTypeCdMCd(String cnslgTypeCdMCd) {
		this.cnslgTypeCdMCd = cnslgTypeCdMCd;
	}

	public String getCnslgTypeCdSCd() {
		return cnslgTypeCdSCd;
	}

	public void setCnslgTypeCdSCd(String cnslgTypeCdSCd) {
		this.cnslgTypeCdSCd = cnslgTypeCdSCd;
	}

	public String getRcpMethCd() {
		return rcpMethCd;
	}

	public void setRcpMethCd(String rcpMethCd) {
		this.rcpMethCd = rcpMethCd;
	}

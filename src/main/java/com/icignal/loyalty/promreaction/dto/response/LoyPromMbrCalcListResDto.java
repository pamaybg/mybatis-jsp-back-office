 ...
 * 1. FileName	: LoyPromMbrCalcListResDto.java
 * 2. Package	: com.icignal.loyalty.promreaction.dto.response
 * 3. Comments	:	
 * 4. Author	: iticd
 * 5. DateTime	: 2020. 7. 15. 오후 1:15:38
 * 6. History	:
 * -----------------------------------------------------------------
 *	Date		 |	Name			|	Comment
 * -------------  -----------------   ------------------------------
...
/*
 * 1. 클래스명	: LoyPromMbrCalcListResDto
 * 2. 파일명	: LoyPromMbrCalcListResDto.java
...
@PersonalData
@CommCode
public class LoyPromMbrCalcListResDto extends GridPagingItemResDto{
	private String rid;

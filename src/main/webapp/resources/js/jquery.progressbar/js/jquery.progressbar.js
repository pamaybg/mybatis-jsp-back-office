	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				height			: 10,											// Height of the progressbar - don't forget to adjust your image too!!!
				callback		: null,											// Calls back with the config object that has the current percentage, target percentage, current image, etc
				boxImage		: PAGE_CONTEXT_PATH + '/resources/js/jquery.progressbar/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	PAGE_CONTEXT_PATH + '/resources/js/jquery.progressbar/images/progressbg_red.gif',
									30: PAGE_CONTEXT_PATH + '/resources/js/jquery.progressbar/images/progressbg_orange.gif',
									70: PAGE_CONTEXT_PATH + '/resources/js/jquery.progressbar/images/progressbg_green.gif'
								},

...
function nav_page_height() {
    ...
    var contentHeight = setHeight + headerHeight;
    ...
    if (contentHeight > windowHeight) {// if content height exceedes actual window height and menuHeight
        ...
        $.root_.css('min-height', contentHeight + 'px');
    ...
    jarvismenu : function(options) {
        ...
        $this.find("li a").click(function() {
            if ($(this).parent().find("ul").size() != 0) {
                ...
                if(typeof window.setParentIframeHeight === 'function') {
                	setTimeout(function() {setParentIframeHeight();}, 300);
                }
            } // end if
        });
    } // end function
...
*/  
datepicker_language2 = window.lang;
...
/*      $('.datepicker').each(function() {
            ...
            lenguageObj.prevText = 'Prev';
            lenguageObj.nextText = 'Next';

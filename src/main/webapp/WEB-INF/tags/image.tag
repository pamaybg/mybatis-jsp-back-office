...
<c:choose>
	...
	<%-- 카카오 이미지 --%>
	<c:when test="${nameValue == 'sns_kakao'}">${pageContext.request.contextPath}/resources/images/common/sns/kakao_login_button_image.PNG</c:when>
	<c:when test="${nameValue == 'sns_naver'}">${pageContext.request.contextPath}/resources/images/common/sns/naver_login_button_image.PNG</c:when>
	<c:when test="${nameValue == 'sns_facebook'}">${pageContext.request.contextPath}/resources/images/common/sns/facebook_login_button_image.png</c:when>
	<c:when test="${nameValue == 'sns_gogle'}">${pageContext.request.contextPath}/resources/images/common/sns/google_login_button_image.png</c:when>
	
	<%-- T10--%>
	<c:when test="${nameValue == 'header_mms'}">${pageContext.request.contextPath}/resources/images/t10/common/header/ico_mms.png</c:when>
	<c:when test="${nameValue == 'header_pw'}">${pageContext.request.contextPath}/resources/images/t10/common/header/ico_pw.png</c:when>
	<c:when test="${nameValue == 'header_logout'}">${pageContext.request.contextPath}/resources/images/t10/common/header/ico_logout.png</c:when>

	<%-- 스탬프 빙고 Preview --%>
	<c:when test="${nameValue == 'bingo_preview'}">${pageContext.request.contextPath}/resources/images/stamp/bingo_preview.png</c:when>
 
    <%-- 게임 --%>
    <c:when test="${nameValue == 'game_dice_preview'}">${pageContext.request.contextPath}/resources/images/game/game_dice_preview.png</c:when>
    <c:when test="${nameValue == 'game_combination_preview'}">${pageContext.request.contextPath}/resources/images/game/game_combination_preview.png</c:when>
    <c:when test="${nameValue == 'game_roulette_preview'}">${pageContext.request.contextPath}/resources/images/game/game_roulette_preview.png</c:when>

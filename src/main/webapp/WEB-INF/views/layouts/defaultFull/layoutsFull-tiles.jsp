...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="${pageContext.request.contextPath}/resources/1.4/ifvCommon/css/reset.css">
		<link rel="stylesheet" type="text/css" media="screen" href="${pageContext.request.contextPath}/resources/1.4/ifvCommon/css/button.css">
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="${pageContext.request.contextPath}/resources/bootstrap/css/smartadmin-skins.css">
...
<%-- 		<script src='${pageContext.request.contextPath}/resources/1.4/ifvCommon/js/templete.js' type="text/javascript"></script> --%>
		...
		<!-- iframe resizer -->
    	<%-- <script src="${pageContext.request.contextPath}/resources/js/iframeResizer/iframeResizer.contentWindow.min.js"></script> --%>

    ...
    var jqGridOption = {
      ...
      rid = obj.rid;
       ...
       serializeGridData : function( data ){
        ...
        url : '<ifvm:action name="getRgstCardList"/>',
        colNames:[
        ...
        colModel:[
             ...
             { name:'ecommMbrNo',   		index:'lm.ECOMM_MBR_NO',  		resizable : true, align:'center',   width:'120px' },
             { name:'cprtCardCd',   		index:'cprtCardCd',  	resizable : true, align:'center',   width:'80px' },
             { name:'cprtCardItemCd',   	index:'cprtCardItemCd',  	resizable : true, align:'center',   width:'80px' },
             { name:'stat',   				index:'stat',  	resizable : true, align:'center',   width:'80px' },
             { name:'regDt',   				index:'lmc.REG_DT',  		resizable : true, align:'center',   width:'150px', 	formatter:'date',  formatoptions:{newformat:"Y-m-d H:i:s"}},
             { name:'apvSrvrTrmStatusCd',   index:'apvSrvrTrmStatusCd',  	resizable : true, align:'center',   width:'80px' },
...
<div>
    <div class="page_btn_area">
        ...
        <div class="col-xs-5 searchbtn_r">
        	<ifvm:inputNew type="button"   btnType="search"  text="M00135"  id="cardListSearchBtn" btnFunc="cardListSearchFn" objCode="rgstcardListSearchBtn_OBJ"/>
 			<ifvm:inputNew type="button"   text="M00278"  id="cardListSearchInitBtn" btnFunc="cardListSearchInit" objCode="rgstcardListSearchInitBtn_OBJ"/>
        </div>
    </div>
...
<div>
    <div class="page_btn_area" >
        <div class="col-xs-7">
         ...
         <div class="col-xs-5 searchbtn_r">
            <ifvm:inputNew type="button"   text="L00326"  id="unMaskBtn" btnFunc="unMaskFn" disabled="true" objCode="rgstunMaskBtn_OBJ"/>
      		<ifvm:inputNew type="button"  btnType="search" text="L00715"  id="btnPointSearch" btnFunc="fnPointSearch"  disabled="true" objCode="rgstbtnPointSearch_OBJ"/>
        </div>
    </div>

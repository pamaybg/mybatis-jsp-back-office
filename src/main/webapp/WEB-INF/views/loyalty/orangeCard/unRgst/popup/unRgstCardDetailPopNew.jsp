...
gUnRgstCardInfo = {
		...
		loadData : function(){
			 $.ifvSyncPostJSON('<ifvm:action name="getUnRgstCardDtlPop"/>', {
				  ...
				  if($.fn.ifvmIsNotEmpty(result)) {
					  ...
					  cardDtlList = $("#cardDtlListGrid").ifvsfGrid({ ejGridOption : gUnRgstCardInfo.ejGridOption });
				  }
			})
		...
		ejGridOption : {
	        ...
	        rowSelected : function (args) {
	        	ridPnt=args.data.ridPnt;
	        	transCheckObj = args.data;
	    		promoCnt = args.transCheckObj.promoCnt;
	        ...
	        dataUrl : '<ifvm:action name="getUnRgstPntTransList"/>',
	        columns:[
	        	{
	        		  ...
	        		  field : 'txnDate', headerText : '<spring:message code="L00604"/>', headerTextAlign : 'center',
	        		  customAttributes : {
	        			  index : 'lpt.TXN_DATE' } //거래일시
	        	  },{
	        		  field : 'apprDate', headerText : '<spring:message code="L00555"/>', headerTextAlign : 'center',
	        		  customAttributes : {
	        			  index : 'lpt.APPR_DATE' } //승인일시
	        	  },{
	        		  field : 'pntTxnTypeCd2', headerText : '<spring:message code="L00556"/>', headerTextAlign : 'center',
	        		  customAttributes : {
	        			  index : 'cc1.MARK_NAME' } //거래상세유형
	        	  },{
	        		  field : 'cardNum', headerText : '<spring:message code="L00414"/>', headerTextAlign : 'center',
	        		  customAttributes : {
	        			  index : 'lpt.CARD_NUM' } //카드번호
	        	  },{
	        		  field : 'pntAmt', headerText : '<spring:message code="L00582"/>', headerTextAlign : 'center',
	        		  customAttributes : {
	        			  index : 'lpt.PNT_AMT' } //발생포인트
	        	  },{
	        		  field : 'usePnt', headerText : '<spring:message code="L00583"/>', headerTextAlign : 'center',
	        		  customAttributes : {
	        			  index : 'lpt.USE_PNT' } //사용포인트
	        	  },{
	        		  field : 'giftPnt', headerText : '<spring:message code="L00584"/>', headerTextAlign : 'center',
	        		  customAttributes : {
	        			  index : 'lpt.GIFT_PNT' } //선물포인트
	        	  },{
	        		  field : 'totalPntAvl', headerText : '<spring:message code="L00468"/>', headerTextAlign : 'center',
	        		  customAttributes : {
	        			  index : 'lpt.TOTAL_PNT_AVL' } //가용포인트
	        	  },{
	        		  ...
	        		  field : 'chnlNo2', headerText : '<spring:message code="L00585"/>', headerTextAlign : 'center',
	        		  customAttributes : {
	        			  index : 'lc2.CHNL_NO' } //동호회번호
	        	  },{
	        		  field : 'chnlNm2', headerText : '<spring:message code="L00586"/>', headerTextAlign : 'center',
	        		  customAttributes : {
	        			  index : 'lc2.CHNL_NM' } //동호회명
	        	  },{
	        		  field : 'groupPnt', headerText : '<spring:message code="L00587"/>', headerTextAlign : 'center',
	        		  customAttributes : {
	        			  index : 'lpt.GROUP_PNT' } //동호회포인트
	        	  },{
	        		  field : 'promoCnt', headerText : '<spring:message code="L00971"/>', headerTextAlign : 'center',
	        		  customAttributes : {
	        			  index : 'promoCnt' } //프로모션
	        	  },{
	        		  field : 'mbrNo', headerText : '<spring:message code="L00562"/>', headerTextAlign : 'center',
	        		  customAttributes : {
	        			  index : 'lpt.MBR_NO' } //선물회원번호
	        	  },{
	        		  field : 'custNm', headerText : '<spring:message code="L00563"/>', headerTextAlign : 'center', template : "#mbrLinkTemplate",
	        		  customAttributes : {
	        			  index : 'lpt.CUST_NM' } //선물회원명
	        	  },{
	        		  field : 'ridPnt', headerText : 'ridPnt', visible : false,
	        		  customAttributes : {
	        			  index : 'lpt.rid' } //ridPnt
	        	  },{
	        		  field : 'cprtCardCd', headerText : 'cprtCardCd', visible : false,
	        		  customAttributes : {
	        			  index : 'lmc.cprt_Card_Cd' } //cprtCardCd
	        	  },{
	        		  field : 'cardTypeCdCode', headerText : 'cardTypeCdCode', visible : false,
	        		  customAttributes : {
	        			  index : 'lpt.CARD_TYPE_CD' } //cardTypeCdCode
	        	  },
	        ],
	        requestGridData : {
		    	  nd   : new Date().getTime(),
	...
	<div class="form-horizontal underline top_well" >
		<div class="page_btn_area">
			...
			<div class="col-xs-5 searchbtn_r">
				<ifvm:inputNew type="button"   text="L01916"  id="apprRequestBtn" btnFunc="apprRequestFn"/>
				<ifvm:inputNew type="button"   text="L02059"  id="requestCancelBtn" btnFunc="requestCancelFn"/>

				<ifvm:inputNew type="button"   text="M00137"  id="cardInfoSave" btnFunc="saveCardInfo"/>
 			</div>
		</div>
	  	<div class="row">

...
//         },
        dataUrl : '<ifvm:action name="getUnRgstCardList"/>',
        columns:[
        	{
	      		  field : 'cardNum', headerText : '<spring:message code="L00414"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'lcri.CARD_NUM' }/*카드번호 */
	      	  },{
	      		  field : 'cardTypeCd', headerText : '<spring:message code="L00192"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'lcri.CARD_TYPE_CD' }/*카드종류 */
	      	  },{
	      		  field : 'activeFlag', headerText : '<spring:message code="M01139"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'lcri.ACTIVE_FLG' }/*사용여부 */
	      	  },{
	      		  field : 'preSavePoint', headerText : '<spring:message code="L00700"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'lcri.PRE_SAVE_POINT' }/*선지급금액 */
	      	  },{
	      		  field : 'preAcuEfctPeriod', headerText : '<spring:message code="L00701"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'lcri.PRE_ACU_EFCT_PERIOD' }/*선적립금유효기간 */
	      	  },{
	      		  field : 'prodCd', headerText : '<spring:message code="L00792"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'lcri.PROD_CD' }/*제품코드  */
	      	  },{
	      		  field : 'firstCardUseDt', headerText : '<spring:message code="L00702"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'lcri.FIRST_CARD_USE_DT' }/*첫카드 사용일시 */
	      	  },{
	      		  field : 'lastCardUseDt', headerText : '<spring:message code="L00702"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'lcri.LAST_CARD_USE_DT' }/*최종카드 사용일시 */
	      	  },{
...
<div>
    <div class="page_btn_area">
        ...
        <div class="col-xs-5 searchbtn_r">
            <ifvm:inputNew type="button" id="unRgstCardListSearchBtn"	btnFunc="unRgstCardListSearch" btnType="search" text="L00081" />
            <ifvm:inputNew type="button" id="unRgstCardListSearchInitBtn" btnFunc="cardListSearchInit" 	text="L00082" />
        </div>
    </div>

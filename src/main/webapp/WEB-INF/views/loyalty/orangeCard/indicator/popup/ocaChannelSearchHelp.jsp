...
var rid ;
var ouTypeCd = '<%= request.getParameter("ouTypeCd") %>';
...
var divNm = decodeURIComponent('<%= cleanXss(request.getParameter("divNm")) %>');
    ...
    var jqGridOption = {
      ...
      //retrunChannel();
       ...
       serializeGridData : function( data ){
        ...
        url : '<ifvm:action name="getOcaChannelSearchHelp"/>',
        colNames:[
                  '<spring:message code="L02069" />',
        ...
        colModel:[
             { name:'divNm',   index:'cd.div_nm',  resizable : true, align:'center',    width:'100px' },
             ...
             { name:'hpNo',   index:'a.hp_no',  resizable : true, align:'center',    width:'100px' },
...
$(document).ready(function(){
    ...
    //선택
    $("#choiceChannelBtn").on("click",function(){
    	if(obj!=null){
    ...
    //닫기
    $("#cancelChnnelSearchHelpBtn").on("click",function(){
...
<div id="pop_main_div_chnl">
	...
	<div class="pop_btn_area">
		...
		<button class="btn btn-sm" id="choiceChannelBtn"><i class="glyphicon glyphicon-check"></i><spring:message code="C00038"/></button>
		 <button class="btn btn-sm" id="cancelChnnelSearchHelpBtn"><spring:message code="M00441"/></button>
	</div>
</div>

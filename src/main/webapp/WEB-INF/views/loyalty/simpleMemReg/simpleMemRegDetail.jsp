    ...
    var jqGridOption = {
      ...
      transactionDetailDtl();   // 상세 보기 이벤트
       ...
       serializeGridData : function( data ){
        ...
        url : '<ifvm:action name="simpleMemTransList"/>',
        colNames:[
        ...
        colModel:[
             { name:'txnUniqNo',   		index:'lpt.TXN_UNIQ_NO',  		resizable : true, 	align:'center',    	width:'180px' },
             { name:'apprDate',   		index:'lpt.APPR_DATE',  		resizable : true, 	align:'center',  	width:'170px' ,	formatter:'date',  formatoptions:{newformat:"Y-m-d H:i:s"} },
             { name:'pntTxnType2Cd',   	index:'lpt.PNT_TXN_TYPE_2_CD',  resizable : true, 	align:'center',     width:'110px' },
             { name:'mbrNo',   			index:'lm.MBR_NO',  			resizable : true, 	align:'center',  	width:'80px', 	formatter: goGridRowMbrLink    },
             { name:'custNm',   		index:'lm.MBR_HID_NM',  		resizable : true, 	align:'center', 	width:'80px'  },
             { name:'memDiv',   		index:'lpt.MEM_DIV',  			resizable : true, 	align:'center',    	width:'80px' },

             //{ name:'memGrade',   		index:'lpt.MEM_GRADE',  		resizable : true, 	align:'center',    	width:'80px' },
             { name:'cardNoDecoding',   index:'lpt.CARD_NUM',  			resizable : true, 	align:'center',    	width:'180px' },
             { name:'cardTypeCd',   	index:'lpt.CARD_TYPE_CD',  		resizable : true, 	align:'center',    	width:'100px' },
             { name:'pntAmt',   		index:'lpt.PNT_AMT',  			resizable : true, 	align:'right',    	width:'115px',	formatter:'integer' },
             //{ name:'usePnt',   		index:'lpt.USE_PNT',  			resizable : true, 	align:'right',    	width:'115px',	formatter:'integer' },
             //{ name:'giftPnt',   		index:'lpt.GIFT_PNT',  			resizable : true,	align:'right',    	width:'115px',	formatter:'integer' },
             { name:'chnlNm',   		index:'lc.CHNL_NM',  			resizable : true, 	align:'center',  	width:'100px', 	formatter :goGridRowChnlLink ,   },
             { name:'prodNm',   		index:'lp.PROD_NM',  			resizable : true, 	align:'center',  	width:'100px', 	formatter :goGridRowProdLink ,   },
             { name:'txnAmt',  	 		index:'lpt.TXN_AMT',  			resizable : true, 	align:'right',    	width:'80px',	formatter:'integer' },
             //{ name:'promoCnt',   		index:'promoCnt',  				resizable : true, 	align:'right',    	width:'140px',	formatter: 'integer' ,	sortable: false},
...
<div class="page_btn_area" id="headForm">
	...
	<div class="col-xs-8 searchbtn_r">
		<ifvm:inputNew type="button" id="vocDetailPopBtn" text="L00819" objCode="vocDetailPopBtn_OBJ"/><!-- 상담생성 -->
		<ifvm:inputNew type="button" btnType="save" text="L00125" id="simpleMemRegInfoSaveBtn" btnFunc="simpleMemRegInfoSaveFn" objCode="simpleMemRegInfoSaveBtn_OBJ"/>
		<ifvm:inputNew type="button" text="L01762" id="certiBtn" btnFunc="fnCertiCard" objCode="simpleMemcertiBtn_OBJ"/>
		<ifvm:inputNew type="button" text="L01698" id="litBtn" btnFunc="simpleMemRegListFn" objCode="simpleMemlitBtn_OBJ"/>
	</div>
	<script>
		...
		<div class="row">
	 	...
	 	<div class="row">
			...
			<div class="col-xs-1 middle">
				<ifvm:inputNew type="button" id="callHpNo" nuc="" btnType="phone" btnFunc="makeCallForHhpNo" className="btn-imgonly"	disabled="true" objCode="simpleMemcallHpNo_OBJ"/>
			</div>
			<script>
...
<div class="page_btn_area" id="headForm">
	...
	<div class="col-xs-8 searchbtn_r">
		<ifvm:inputNew type="button"  text="L00326" id="unMaskBtn" btnFunc="unMaskFn"  disabled="true" objCode="simpleMemunMaskBtn_OBJ"/>
		<ifvm:inputNew type="button"   text="L00588" id="pointDtlPopBtn" btnFunc="pointDtlPopFn"  disabled="true" objCode="simpleMempointDtlPopBtn_OBJ"/>
	</div>
</div>

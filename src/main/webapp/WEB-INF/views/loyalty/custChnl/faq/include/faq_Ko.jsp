...
<div class="page_btn_area">
    ...
    <div class="col-xs-7 searchbtn_r">
		<ifvm:inputNew type="button" id="btnSave" btnFunc="btnSaveClick" btnType="save" text="L00074" objCode="faqKobtnSave_OBJ"/>
    </div>
</div>
...
<!-- 	<div class="row qt_border"> -->
<%-- 		<ifvm:inputNew type="text" id="dpSeq" names="dpSeq" dto="dpSeq" required="true" label="L02333" labelClass="2" conClass="1" /> --%>
<!-- 	</div> -->
<!-- 	 <div class="row qt_border"> -->
	...
	if(faqId != null){
		if(validation.confirm() === false) return;
			...
			if(confirm('저장하시겠습니까?') === false) return;
				   ...
				   if(totalByte > 999 ){
				      alert('상세내용은 최대 3000Byte를 넘을 수 없습니다.')
				   }else{
						if( faqId == null ){ //신규

	...
	<div class="form-horizontal underline top_well"  >
		<div class="row qt_border" >
			...
			<div class="col-xs-12">
				...
				<ifvm:inputNew type="button" text="L01671"  id="fileSearchBtn" btnFunc="fileSearchFn" objCode="categoryUploadSearch_OBJ"/>
			</div>
...
<div class="pop_btn_area">
	<ifvm:inputNew type="button" btnType="upload" text="M00137" id="uploadBtn" btnFunc="fnUploadsave" objCode="categoryUploadSave_OBJ"/>
	<ifvm:inputNew type="button" btnType="cancel" text="I00404" btnFunc="fnClose" objCode="categoryUploadClose_OBJ"/>
</div>
<script>
...
function fileSearchFn() {
	fnExcelUpload({
		url: '<ifvm:action name="uploadExcelCategory"/>',

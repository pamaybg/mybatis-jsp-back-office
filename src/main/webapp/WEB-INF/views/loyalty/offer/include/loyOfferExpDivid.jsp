...
function setExpDividGrid() {
    ...
    var jqGridOption = {
        ...
        data: loyOfferData.expDividList,
        datatype: 'clientSide',
        colNames: colNames,
        colModel: colModel,
        rowList : [100000],
...
function expDividAdd() {
    ...
    if (chkExpDividDtlValidation) {
        ...
        //전역변수에 값 매핑
        loyOfferData.expDividList = expDividGrid.getAllRowData();
...
function chkExpDividList(_checkedData) {
    for (var i = 0; i < loyOfferData.expDividList.length; i++) {
        var deskData = loyOfferData.expDividList[i];
...
<div id="loyOfferUseLmtChnlWrap">
    <div class="page_btn_area" id=''>
        <div class="col-xs-12 searchbtn_r">
            <button class="btn btn-sm" id="expDividNewBtn" objCode="expDividNewBtn_OBJ">
                <spring:message code="M01852"/>
            </button>
            <button class="btn btn-sm" id="expDividEditBtn" objCode="expDividEditBtn_OBJ">
                <spring:message code="M00259"/>
            </button>
            <button class="btn btn-sm" id='expDividRemoveBtn' objCode="expDividRemoveBtn_OBJ">

...
function getCampaignList() {
    var ejGridOption = {
        ...
        columns : [
        	{
      		  field : 'promNm', headerText : '프로모션 명', headerTextAlign : 'center', textAlign : 'left', customAttributes :{searchable : true}
      	  },{
    		  field : 'promTypeLv1CdNm', headerText : '대유형', headerTextAlign : 'center', textAlign : 'center' ,customAttributes :{index : 'promTypeLv1Cd'}
    	  },{
    		  field : 'promTypeLv2CdNm', headerText : '소유형', textAlign : 'center', headerTextAlign : 'center' , customAttributes :{index : 'promTypeLv2Cd'}
    	  },{
    		  field : 'promStatCdNm', headerText : '상태', headerTextAlign : 'center', textAlign : 'center' , customAttributes :{index : 'promStatCd'}
    	  },{

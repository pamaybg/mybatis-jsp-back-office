...
<jsp:include page="/WEB-INF/views/loyalty/campaign/include/campaignListScriptNewPage.jsp"/>
...
<div>
    <div class="page_btn_area">
        <div class="col-xs-7">
            <span><spring:message code="프로모션 기획/실행" /></span>
        </div>
        <div class="col-xs-5 searchbtn_r">
            <button class="btn btn-sm" id="campaignListSearchBtn" objCode="campaignListSearch_OBJ">
            	<i class="fa fa-search"></i>
                <spring:message code="M00135" />
            </button>
            <button class="btn btn-sm" id="campaignListSearchInitBtn" objCode="campaignListSearchInit_OBJ">
...
<div>
    <div class="page_btn_area" id=''>
        ...
        <div class="col-xs-5 searchbtn_r">
            <button class="btn btn-sm" id="campaignNewBtn" objCode="campaignNew_OBJ"><%-- 신규 --%>
                <spring:message code="M00274" />
            </button>
            <button class="btn btn-sm" id='campaignActiveBtn' objCode="campaignActive_OBJ"><%-- 중지 --%>
                <spring:message code="활성" />
            </button>
            <button class="btn btn-sm" id='campaignStopBtn' objCode="campaignStop_OBJ"><%-- 중지 --%>
                <spring:message code="M02154" />
            </button>
            <button class="btn btn-sm" id='campaignRemoveBtn' objCode="campaignRemove_OBJ"><%-- 삭제 --%>

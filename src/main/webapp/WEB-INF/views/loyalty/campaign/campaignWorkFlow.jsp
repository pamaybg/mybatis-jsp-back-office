...
%>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/loyalty/diagram/js/util.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/resources/js/loyalty/diagram/js/NodeDataClass.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/resources/js/loyalty/diagram/js/methods.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/resources/js/loyalty/diagram/js/events.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/resources/js/loyalty/diagram/js/intelligentshapes.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/resources/js/loyalty/diagram/js/palettes.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/resources/js/loyalty/diagram/js/control.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/resources/js/loyalty/diagram/js/pathseg.js" type="text/javascript"></script>
...
var pgmRid = null;
var offerRid = null;
var tgtGrpIncRid = null;
var expectTgtGrpRid = null;
var promKpiRid = null;
var tgtGrpCntrlRid = null;
//diagram 객체
var diagram;
var symbolpalette;
...
function getCampaignWorkflowData() {
  $.ifvSyncPostJSON('<ifvm:action name="getCampaignWorkflowStatusList"/>', {
   ...
   function(result) {
	   pgmRid = result[0].data.campaignDefaultInfo.pgmRid;
...
function campaignWorkflowTempUseBtn() {
	var templateUseFlag = campaign.templateUseFlag == "0" ? "1" : "0";
...
function promStatCheck() {
	var camNodes = findNodeByNodeType("INFO");
	var promStatCd='';
	//데이터 및 유형 확인
	if ($.fn.ifvmIsNotEmpty(camNodes)) {
		var camNode = camNodes[0];
		if ($.fn.ifvmIsNotEmpty(camNode.addInfo.data)) {
			if ($.fn.ifvmIsNotEmpty(camNode.addInfo.data.campaignDefaultInfo)) {
				promStatCd = camNode.addInfo.data.campaignDefaultInfo.promStatCd;
				$("#promStatCd").val(promStatCd);
			}
		}
	}
	if(promStatCd!='' && promStatCd!='W') {
		$("#promotionInfoPopSaveBtn").attr('disabled',true);
		$("#promRuleSaveBtn").attr('disabled',true);
		$("#promotionActionSaveBtn").attr('disabled',true);
		$("#selectTempBtn").attr('disabled',true);
	}
}
...
<div>
	...
	<div class="page_btn_area">
	    <div class="col-xs-7">
	        <span><spring:message code="L02448" /></span>
	    </div>
	    <div class="col-xs-5 searchbtn_r">
	    	<%-- <button class="btn btn-sm" id="campaignWorkflowClearBtn">
                <spring:message code="M00278" />
            </button>  --%>
            <%-- <button class="btn btn-sm" id="campaignWorkflowTempUseBtn" disabled>
                <i class="glyphicon glyphicon-check"></i>
                <span id="campaignWorkflowTempUseBtnText" > <spring:message code="M01381" /></span>
            </button> --%>
            <button class="btn btn-sm" id="campaignWorkflowSaveBtn" objCode="campaignWorkFlowSave_OBJ">
            	<i class="glyphicon glyphicon-check"></i>
                <spring:message code="M00307" />
            </button>
            <button class="btn btn-sm" id="campaignListBtn" objCode="campaignWorkFlowList_OBJ">
    ...
    <div class="sample-main">
        ...
        <div id="main-left">
            <div id="symbolpalette" style="width:500px; height:100%;"></div>
            <div id="minimizedPalette" style="width:500px; height:100%;"></div>
        </div>

        <div class="middle_section"></div>

        <div id="main-right" class="width: 100%; height: 500%">
            <div id="diagram"></div>
        </div>
    </div>

    <div id="Overview-div" class="Overview-div" style="width: 500px; float: left; display: none">
        <div id="Overview"></div>
        <table cellpadding="3">
            <tr>

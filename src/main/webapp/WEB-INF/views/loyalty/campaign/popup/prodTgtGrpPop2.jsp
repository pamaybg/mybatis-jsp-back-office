...
function getProdTgtGrpList(){
	var ejGridOption = {
		rowSelected : function (args) {
			var data = args.data;
			prodTgtGrpId2 = data.rid;
			prodTgtGrpNm2 = data.prodTgtGrpNm;
			prodTgtGrpNo2 = data.prodTgtGrpNo;
        },
...
$(document).ready(function(){
	...
	$("#btnProdTgtGrpPopSelect").click(function(){
		if(prodTgtGrpIncList.opt.gridControl.getSelectedRecords().length == 0){
    		...
    		$('#prodTgtGrpNo2').val(prodTgtGrpNo2);
    		$('#prodTgtGrpNm2').val(prodTgtGrpNm2);
    		prodTgtGrpRid2 = prodTgtGrpId2;
        	$.fn.ifvmPopupClose();
    	}
	});

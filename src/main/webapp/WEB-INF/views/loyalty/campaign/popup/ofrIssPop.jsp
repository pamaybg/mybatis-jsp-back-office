...
<div class="pop_btn_area">
	<button class="btn btn-sm btn_gray"  id="btnCommOfferPopSelect" objCode="">
		<spring:message code="L00072" />
	</button> 
	<button class="btn btn-sm btn_lightGray2" id="btnCommOfferPopCancel" objCode="">
...
function mktOfferListSetting(){
	var ejGridOption = {
        ...
        dataUrl : '<ifvm:action name="getOfferIssListPop"/>',
        columns:[
        	{

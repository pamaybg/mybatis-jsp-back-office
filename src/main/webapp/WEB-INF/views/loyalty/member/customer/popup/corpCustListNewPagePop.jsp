...
function CustDetail(id) {
	//개인정보 조회 이력남기기
	$.fn.ifvmPersonalCondLogPageId("CORP_CUST_SEARCH_POP", true);
	location.href = '<ifvm:url name="corpcustDetailNewPage"/>' + '?rid=' + id;
}
...
<div>
    <div class="page_btn_area">
        <div class="col-xs-7">
            <span><spring:message code="법인고객조회"/></span>
        </div>

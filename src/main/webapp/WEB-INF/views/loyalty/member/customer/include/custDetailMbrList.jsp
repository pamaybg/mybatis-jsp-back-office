...
function custDetailMbrList() {
	var ejGridOption = {
	        ...
	        columns : [
			 	{
					field : 'mbrNo', headerText : '<spring:message code="L00690"/>',  textAlign : 'center', customAttributes :{searchable : true}, template: "#mbrLinkTemplate"
				}, {
					...
					field : 'sbscPathCdNm', headerText : '<spring:message code="가입경로"/>',  textAlign : 'center', customAttributes :{index : 'sbscPathCd'}
				},{

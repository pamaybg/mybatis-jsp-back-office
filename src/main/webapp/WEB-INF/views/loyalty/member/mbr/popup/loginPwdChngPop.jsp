...
<div class="form-horizontal underline top_well clearfix" id="userPwdDiv">
<br>
		<div class="row">
...
<div class="pop_btn_area">
    ...
    <ifvm:inputNew type="button" text="발급" btnFunc="saveFn" className="btn btn-sm btn_gray" objCode="loginPwdChngSave_OBJ"/>
    <ifvm:inputNew type="button" text="L00073" btnFunc="closeFn" className="btn btn-sm btn_gray" objCode="loginPwdChngClose_OBJ"/>
</div>
...
function saveFn(){
	...
	validation = $("#userPwdDiv").ifvValidation();	
	var data = $('#userPwdDiv').getSubmitData();
	...
	if(validation.confirm()){
			$.ifvSyncPostJSON('<ifvm:action name="editMbrLoiginPwLL"/>', {
				  ridMbr : mbr_rid
				 ,ridCust : custRid
				 ,ridVal : ridVal

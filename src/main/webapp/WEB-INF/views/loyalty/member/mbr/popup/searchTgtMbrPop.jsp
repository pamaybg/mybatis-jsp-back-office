...
<div class="form-horizontal top_well underline">
   <div class="page_btn_area">
       ...
       <div class="col-xs-5 searchbtn_r">
           <button class="btn btn-sm" id="searchCondBtn" objCode=""><i class="fa fa-search"></i>
               <spring:message code="L00081"/>
           </button>
           <button class="btn btn-sm" id="searchCondInitBtn" objCode="">
...
<div class="pop_btn_area">
    <button class="btn btn-sm btn_gray" id="selectMbrBtn">
        <i class="glyphicon glyphicon-check"></i>
		<spring:message code="L00123"/>
    </button>
    <button class="btn btn-sm btn_lightGray2" id="cancelPopBtn">
...
function getMbrList(){
	var ejGridOption = {
        loadComplete : function(obj){
    		...
    		//$.fn.ifvmComCondLogging("LOY_MBR_GIFT_POIN_TGT_MBR", mbrListPopGrid.opt.data.records);
        },
	    ...
	    dataUrl : '<ifvm:action name="searchMbrGiftPntTgtMbr"/>',
	    columns : [
	    	{
...
$(document).ready(function(){
    ...
    $('#selectMbrBtn').on('click', function(){
    	...
    	if(mbrListPopGrid.opt.gridControl.getSelectedRecords() == ''){
    		...
    		$("#tgtMbrNo").val(dataArr[0].mbrNo);
    		$("#tgtCustNm").val(dataArr[0].custNm);
    		searchCondInit("mbrListPopGrid");
    		$.fn.ifvmPopupClose();
    	}
    }); 

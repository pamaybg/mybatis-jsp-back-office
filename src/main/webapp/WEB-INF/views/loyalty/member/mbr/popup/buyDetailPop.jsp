...
<script>
	function buyDetailSelect(){
	    var ejGridOption = {
	        ...
	        dataUrl : '<ifvm:action name="buyDetailSelect"/>',
	        columns : [
	        	{
	        	...
	        	{
		             field : 'prodNm', headerText : '<spring:message code="상품명"/>', headerTextAlign: 'center', width: '220px' ,textAlign : 'left', customAttributes : {index : 'prodNm',sortable: false}
		        },
	            {

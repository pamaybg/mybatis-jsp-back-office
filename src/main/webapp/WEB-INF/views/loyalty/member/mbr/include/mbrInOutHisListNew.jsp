...
gMbrInOutList  = {
		...
		jqGridOption : 	{
		     ...
		     columns :[
		    	 {
		    		  field : 'mbrNo', headerText : '<spring:message code="L00165"/>', headerTextAlign : 'center',
		    		  customAttributes : {
		    			  index : 'lm.mbr_no',
		    			  title : '{{:mbrNo}}'
		    		  }
		    	  },{
		    		  field : 'mbrNo', headerText : '<spring:message code="L01297"/>', headerTextAlign : 'center',
		    		  customAttributes : {
		    			  index : 'lm.mbr_no',
		    			  title : '{{:mbrNo}}'
		    		  }
		    	  },{
		    		  field : 'mbrNo', headerText : '<spring:message code="L00601"/>', headerTextAlign : 'center',
		    		  customAttributes : {
		    			  index : 'lm.mbr_no',
		    			  title : '{{:mbrNo}}'
		    		  }
		    	  },{
		    		  field : 'mbrNo', headerText : '<spring:message code="L02184"/>', headerTextAlign : 'center',
		    		  customAttributes : {
		    			  index : 'lm.mbr_no',
		    			  title : '{{:mbrNo}}'
		    		  }
		    	  },{
		    		  field : 'mbrNo', headerText : '<spring:message code="L01981"/>', headerTextAlign : 'center',
		    		  customAttributes : {
		    			  index : 'lm.mbr_no',
		    			  title : '{{:mbrNo}}'
		    		  }
		    	  },{
		    		  field : 'mbrNo', headerText : '<spring:message code="M00862"/>', headerTextAlign : 'center',
		    		  customAttributes : {
		    			  index : 'lm.mbr_no',
		    			  title : '{{:mbrNo}}'
		    		  }
		    	  },{
		    		  field : 'mbrNo', headerText : '<spring:message code="L01420"/>', headerTextAlign : 'center',
		    		  customAttributes : {
		    			  index : 'lm.mbr_no',
		    			  title : '{{:mbrNo}}'
		    		  }
		    	  },{
		    		  field : 'mbrNo', headerText : '<spring:message code="L01299"/>', headerTextAlign : 'center',
		    		  customAttributes : {
		    			  index : 'lm.mbr_no',
		    			  title : '{{:mbrNo}}'
		    		  }
		    	  },{
		    		  field : 'mbrNo', headerText : '<spring:message code="L01298"/>', headerTextAlign : 'center',
		    		  customAttributes : {
		    			  index : 'lm.mbr_no',
		    			  title : '{{:mbrNo}}'
		    		  }
		    	  },{
		    		  field : 'mbrNo', headerText : 'rid',
		    		  customAttributes : {
		    			  index : 'lm.mbr_no',
		    			  title : '{{:mbrNo}}'
		    		  }
		    	  },{
		    		  field : 'mbrNo', headerText : 'chnlTypeCd',
		    		  customAttributes : {
		    			  index : 'lm.mbr_no',
		    			  title : '{{:mbrNo}}'
		    		  }

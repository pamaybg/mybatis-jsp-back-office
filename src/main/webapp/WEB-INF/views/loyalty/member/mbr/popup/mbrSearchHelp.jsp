	...
	<div>
	    <div class="page_btn_area">
	        ...
	        <div class="col-xs-5 searchbtn_r">
	            <button class="btn btn-sm" id="mbrSearchHelpSearchBtn" objCode="mbrSearchHelpSearchBtn_OBJ"><i class="fa fa-search"></i>
	                <spring:message code="M00135" />
	            </button>
	            <button class="btn btn-sm" id="mbrSearchHelpSearchInitBtn" objCode="mbrSearchHelpSearchInitBtn_OBJ">
...
<!-- 		<div class="col-xs-12">* 휴대폰 Like 검색은 휴대폰번호 뒷자리 4자리만 검색 가능합니다.</div> -->
	...
	<div class="pop_btn_area">
		<ifvm:inputNew type="button" btnType="save"  text="C00038"  id="choiceMbrBtn" btnFunc="choiceMbrFn" objCode="choiceMbrBtn_OBJ"/>
		<ifvm:inputNew type="button"   text="M00441"  id="cancelMbrSearchHelpBtn" btnFunc="cancelMbrSearchHelpFn" objCode="cancelMbrSearchHelpBtn_OBJ"/>
	</div>
</div>
...
function reservImageViewPopInit() {
	...
	if(path != null) {
		...
		reservImageViewPopupClose();
		alert("URL이 올바르지 않습니다.");
	}
	
	$("#reservImageViewPopArea").html(html);
}

$(document).ready(function() {
	reservImageViewPopInit();
});
</script>

<div id='reservImageViewPop'>
	<div class="pop_inner_wrap form-horizontal" id="reservImageViewPopArea"  style='background-color:black'>
	</div>
</div>
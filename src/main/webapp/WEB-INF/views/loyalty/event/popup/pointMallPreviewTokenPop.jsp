...
function getEventPreviewToken(){
	...
	if (validation.confirm()) {
		...
		$.ifvSyncPostJSON('<ifvm:action name="getPointMallPreviewToken"/>', data
		, function(result) {
	...
	<div class="pop_inner_wrap form-horizontal">
	    ...
	    <div class="row">
	    	<div class="col-xs-12 control_content" style="padding-left:30px; color:red;">
		    	<li >포인트몰 이벤트 미리보기를 위한 glolive 로그인 이메일을 입력하여 주세요.</li>
		    	<li >미리보기 URL을 열기전에 glolive 로그인을 먼저 해주세요.</li>
		    	<li >토큰 생성 후 유효시간은 30분입니다.</li>
		    	<li >포인트몰 미리보기 화면에서 벗어나고 싶다면 다른 메뉴 화면으로 이동하시면 미리보기가 해제됩니다.</li>
	    	</div>
	    </div>
		<div class="row">

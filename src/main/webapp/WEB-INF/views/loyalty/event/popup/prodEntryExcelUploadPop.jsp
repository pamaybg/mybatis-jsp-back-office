...
<div id ="uploadForm">
	<div class="form-horizontal underline top_well"  >
			...
			<div class="col-xs-12">
				...
				<!-- 찾아보기 버튼 -->
				<ifvm:inputNew type="button" text="L01671"  id="fileSearchBtn" btnFunc="fileSearchFn" objCode="prodEntryUploadfileSearchBtn_OBJ"/>
			</div>
		</div>
...
<div class="pop_btn_area">
	<!-- 저장 버튼 -->
	<ifvm:inputNew type="button" btnType="upload" text="M00137" id="uploadBtn" btnFunc="fnUploadsave" objCode="prodEntryExcelSave_OBJ"/> <!--  objCode="faqUploaduploadBtn_OBJ" -->
	<!-- 닫기 버튼 -->
	<ifvm:inputNew type="button" btnType="cancel" text="I00404" btnFunc="fnClose" objCode="prodEntryExcelClose_OBJ"/> <!--  objCode="faqUploadclose_OBJ" -->
</div>
...
// 엑셀업로드 팝업창 닫기
function fnClose() {
	prodDialog.close(); // 도로명주소 엑셀업로드 팝업창 닫기
}

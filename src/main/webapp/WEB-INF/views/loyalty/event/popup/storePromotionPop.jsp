	    ...
	    columns:[
	    	{
	      		  ...
	      		  field : 'dispNo', headerText : '캠페인 번호', headerTextAlign : 'center', textAlign : 'center', width:'80px',
	      		  customAttributes : {
	      		  ...
	      		  field : 'startDd', headerText : '시작일', headerTextAlign : 'center', textAlign : 'center', width:'80px',
	      		  customAttributes : {
	      			  index : 't1.CAM_START_DD' }/* 시작일 */
	      	  },{
	      		  field : 'endDd', headerText : '종료일', headerTextAlign : 'center', textAlign : 'center', width:'80px',
	      		  customAttributes : {
	      			  index : 't1.CAM_END_DD' }/* 종료일*/
	      	  },{
	      		  field : 'offerType', headerText : '오퍼유형', headerTextAlign : 'center', textAlign : 'center', width:'80px',
	      		  customAttributes : {
	      			  index : 't6.MARK_NAME' }/* 오퍼유형*/
	      	  },{
	      		  field : 'selfTotAmt', headerText : '포인트', headerTextAlign : 'center', textAlign : 'right', width:'80px',  format : '{0:n0}',
	      		  customAttributes : {
...
function saveStorePromotion(){
	dispNo = getPromotionGrid.opt.gridControl.getSelectedRecords()[0].dispNo;
	$.ifvSyncPostJSON('<ifvm:action name="saveEventStorePnt"/>',{
		dispNo : dispNo
	  , ridStore : storeRid
	  , storeType : 'P4'
	},function(result){
...
$(document).ready(function(){
    ...
    $('#selectBtn').on('click', function(){
    	if(getPromotionGrid.opt.gridControl.getSelectedRecords()[0] == null){
    		...
    		dispNo = getPromotionGrid.opt.gridControl.getSelectedRecords()[0].dispNo;
    		promotionRid = getPromotionGrid.opt.gridControl.getSelectedRecords()[0].id;
    		saveStorePromotion();
    		promotionPopUpClose();
    	}
    });

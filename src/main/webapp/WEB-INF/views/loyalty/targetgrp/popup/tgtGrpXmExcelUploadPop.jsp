...
<div class="pop_btn_area">
	<ifvm:inputNew type="button" btnType="upload" text="M00137" id="uploadBtn" btnFunc="fnUploadsave" objCode="tgtGrpXmSave_OBJ"/>
	<ifvm:inputNew type="button" btnType="cancel" text="I00404" btnFunc="fnClose" objCode="tgtGrpXmClose_OBJ"/>
</div>
<script>
...
function fileSearchFn() {
	fnExcelUpload({
		url: '<ifvm:action name="uploadExcelTgtGrpXm"/>',

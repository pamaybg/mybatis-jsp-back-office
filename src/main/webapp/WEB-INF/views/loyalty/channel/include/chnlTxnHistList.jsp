...
function getchnlTxnHistListSearch(searchType){
    var jqGridOption = {
        ...
        url : '<ifvm:action name="getChnlTxnHistList"/>',
        colNames:[
        ...
        colModel:[
             ...
             { name:'prodNm',   	index:'f.prod_nm',  	resizable : true, align:'center',   width:'100px' },
             { name:'txnAmt',   	index:'a.txn_amt',  	resizable : true, align:'right',    width:'100px',	sortable:false,		formatter:'integer'},
             { name:'pntAmt',   	index:'a.pnt_amt',  	resizable : true, align:'right',    width:'100px',	sortable:false, 	formatter:'integer'},
             { name:'usePnt',   	index:'a.use_pnt',  	resizable : true, align:'right',    width:'100px',	sortable:false,		formatter:'integer'},
             { name:'giftPnt',   	index:'a.gift_pnt',  	resizable : true, align:'right',    width:'100px',	sortable:false,		formatter:'integer'},

...
function getFraudAcrlCntTop(){
    var ejGridOption = {
        ...
        dataUrl : '<ifvm:action name="getFraudAcrlCntTopList"/>',
        columns:[
        	 {
...
//         },
    ...
    fraudEmpGrid = $("#fraudAcrlCntTopGrid").ifvsfGrid({ ejGridOption : ejGridOption });
}
...
<div>
    <div class="page_btn_area">
        ...
        <div class="col-xs-5 searchbtn_r">
            <button class="btn btn-sm" id="reportSearchBtn" objCode="fraudAcrlreportSearchBtn_OBJ"><i class="fa fa-search"></i>
                <spring:message code="M00135" />
            </button>
            <button class="btn btn-sm" id="reportSearchInitBtn" objCode="fraudAcrlreportSearchInitBtn_OBJ">
...
<div>
    <div class="page_btn_area" id =''>
        ...
        <div class="col-xs-5 searchbtn_r">
         <ifvm:inputNew type="button"   btnType="download"  text="M01218"  btnFunc="fnIfvExcelDownload('fraudAcrlCntTopGrid')" objCode="fraudAcrlExcel_OBJ"/>
          <%--   <button class="btn btn-sm" id="excelExportBtn" btnFunc="fnIfvExcelDownload2('fraudEmpGrid')">
                <spring:message code="M01218" />
            </button> --%>
        </div>
    </div>
    <div id="fraudAcrlCntTopGrid" class="white_bg grid_bd0"></div>
</div>

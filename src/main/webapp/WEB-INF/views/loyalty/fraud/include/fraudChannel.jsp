...
function getFraudChannel(){
    var ejGridOption = {
        ...
        dataUrl : '<ifvm:action name="getFraudChannelList"/>',
        columns:[
        	 {
                 field : 'chnlNo' ,headerText : '매장코드', headerTextAlign : 'center', textAlign: 'center',
                 customAttributes : {
                    index : 'chnlNo' , sortable: false}/*  */
              },{
                 field : 'chnlNm' ,headerText : '매장명', headerTextAlign : 'center', textAlign: 'left',
                 customAttributes : {
                    index : 'chnlNm' , sortable: false}/*  */
              },{
                 field : 'prePntAmt' ,headerText : '조회월 전월적립포인트(A)', headerTextAlign : 'center', textAlign: 'right',format : '{0:n0}',
                 customAttributes : {
                    index : 'prePntAmt' , sortable: false}/*  */
              },{
                 field : 'pntAmt', headerText : '조회월 적립포인트(B)', headerTextAlign : 'center', textAlign: 'right',format : '{0:n0}',
                 customAttributes : {
                    index : 'pntAmt' , sortable: false}/* */
              },{
                 field : 'escalRate', headerText : '상승율((B-A)/A)', headerTextAlign : 'center', textAlign: 'right',
                 customAttributes : {
                    index : 'escalRate' , sortable: false}/*   */
              }
        ],
//         stackedHeaderRows: [{
...
//         },
    ...
    fraudEmpGrid = $("#fraudChannelGrid").ifvsfGrid({ ejGridOption : ejGridOption });
}
...
<div>
    <div class="page_btn_area">
        ...
        <div class="col-xs-5 searchbtn_r">
            <button class="btn btn-sm" id="reportSearchBtn" objCode="fraudChareportSearchBtn_OBJ"><i class="fa fa-search"></i>
                <spring:message code="M00135" />
            </button>
            <button class="btn btn-sm" id="reportSearchInitBtn" objCode="fraudChareportSearchInitBtn_OBJ">
...
<div>
    <div class="page_btn_area" id =''>
        ...
        <div class="col-xs-5 searchbtn_r">
         <ifvm:inputNew type="button"   btnType="download"  text="M01218"  btnFunc="fnIfvExcelDownload('fraudChannelGrid')" objCode="fraudChaExcel_OBJ"/>
          <%--   <button class="btn btn-sm" id="excelExportBtn" btnFunc="fnIfvExcelDownload2('fraudEmpGrid')">
                <spring:message code="M01218" />
            </button> --%>
        </div>
    </div>
    <div id="fraudChannelGrid" class="white_bg grid_bd0"></div>
</div>

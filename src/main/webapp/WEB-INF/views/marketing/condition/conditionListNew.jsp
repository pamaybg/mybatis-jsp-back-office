...
function conditionResultGrid() {
	...
	var ejGridOption = {
		...
		columns:[
	    	{
	      		  field : 'menuName', headerText : '<spring:message code="M00516"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'p.pgm_nm' }
	      	  },{
	      		  field : 'condName', headerText : '<spring:message code="M00517"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'mcs.srch_cond_dp_val' }
	      	  },{
	      		  field : 'condType', headerText : '<spring:message code="M00518"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'cc.mark_name' }
	      	  },{
	      		  field : 'tableName', headerText : '<spring:message code="M00519"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'st1.tbl_eng_nm' }
	      	  },{
	      		  field : 'tgtTable', headerText : '<spring:message code="M00520"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'stl2.tbl_eng_nm' }
	      	  },{
	      		  field : 'tgtClm', headerText : '<spring:message code="M00521"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'scl.col_eng_nm' }
	      	  },{
	      		  field : 'joinSrcClm', headerText : '<spring:message code="M00522"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'scl2.col_eng_nm' }
	      	  },{
	      		  field : 'joinTgtClm', headerText : '<spring:message code="M00523"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'scl3.col_eng_nm' }
	      	  },{
	      		  field : 'defaultCond', headerText : '<spring:message code="M00525"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'cc2.mark_name' }
	      	  },{

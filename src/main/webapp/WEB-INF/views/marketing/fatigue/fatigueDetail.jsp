...
<div>
	...
	<div class="well form-horizontal underline" id="selectForm" >
		<div class="row  qt_border">
			<ifvm:inputNew type="text"  id="fatiTitle" dto="fatiTitle" names="fatiTitle" label="피로도명" labelClass="1" conClass="10" required="true"/>
		</div>

		<div class="row qt_border">
			<ifvm:inputNew type="text" id="fatiRestrictionDay" dto="fatiRestrictionDay" label="제한일" labelClass="1" conClass="2"/>
			<ifvm:inputNew type="text" id="fatiMaxRestrictionDayCnt" dto="fatiMaxRestrictionDayCnt" label="최대 제한횟수" labelClass="2" conClass="3"/>
			<ifvm:inputNew type="text" id="fatiState" names="fatiState" dto="fatiState" label="피로도 상태" labelClass="1" conClass="2" disabled="true"/>
		</div>
		<div class="row qt_border">
			...
			<ifvm:inputNew type="text" id="createDate" dto="createDate" label="M01044" labelClass="1" conClass="1" disabled="true"/>
		</div>
		<div class="row qt_border">
			<ifvm:inputNew type="checkBox" id="pushFlag" label="PUSH" labelClass="1" conClass="1" />
			<ifvm:inputNew type="checkBox" id="emailFlag" label="EMAIL" labelClass="1" conClass="1" />
			<ifvm:inputNew type="checkBox" id="kakaoFrFlag" label="친구톡" labelClass="1" conClass="1" />
			<ifvm:inputNew type="text" id="modifyBy" dto="modifyBy" label="M01045" labelClass="1" conClass="2" disabled="true"/>
			<ifvm:inputNew type="text" id="modifyDate" dto="modifyDate" label="M01046" labelClass="1" conClass="1" disabled="true"/>
		</div>
		<div class="row qt_border">

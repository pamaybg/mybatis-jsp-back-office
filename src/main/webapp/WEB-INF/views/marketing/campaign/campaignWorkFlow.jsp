...
function campaignWorkflowTempUseBtn() {
    ...
    $("#contentPopupCon").ifvsfPopup({
        enableModal : true,
        enableResize: false,
        contentUrl: '<ifvm:url name="templateCheckPop"/>',
        contentType: "ajax",
        title: '<spring:message code="매장 사용여부"/>',
        width: 500,
        close : 'popupClose' });
}
...
function approvalPopOpenFun() {
    diagram.clearSelection();
    var node=diagram.model.nodes[0];
    diagram.addSelection(node);

    var handleParam = {}
    handleParam.method = "/marketing/campaign/popup/approvalPop"
    handleParam.methodType = "POPUP"

    OnMethods(this.diagram._selectedObject, handleParam);
}
...
$(function () {
  ...
  //캠페인목록 이동
    ...
    $('#approvalPopOpen').on('click', function(){
        approvalPopOpenFun();
    });
    ...
    window.onload = function(){
        setTimeout(function(){
          ...
          //console.log(t.loadEventEnd - t.responseEnd);
            if(empType == "S"){
                $("#campaignWorkflowTempUseBtn").hide();
            }
...
<div class="page-title">
    <h1>
        <spring:message code="상세정보"/>
        &gt; <spring:message code="Workflow"/>
    </h1>
</div>
<div>
	<div class="page_btn_area">
	    <div class="col-xs-7">
	        ...
	        <span>Workflow</span>
                <br>
            * 기본정보, 타겟팅, 일정, SMS/LMS 내용을 변경 시 '저장' 버튼을 꼭 눌러주세요
	    </div>
	    <div class="col-xs-5 searchbtn_r">
	    	<%-- <button class="btn btn-sm" id="campaignWorkflowClearBtn">
                <spring:message code="M00278" />
            </button>  --%>
<%--                <button class="btn btn-sm" id="approvalPopOpen" objCode="approvalPopOpen_OBJ">--%>
<%--                    <spring:message code="M03035" />--%>
<%--                </button>--%>

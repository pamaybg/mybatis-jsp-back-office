...
<jsp:include page="/WEB-INF/views/marketing/campaign/include/campaignListScriptNew.jsp"/>
...
<div class="page-title">
    <h1>
        <spring:message code="캠페인 조회 및 등록"/>
...
<div>
    <div class="page_btn_area" id=''>
        ...
        <div class="col-xs-5 searchbtn_r">
            ...
            <button class="btn btn-sm" id="approvalRequestBtn" objCode="approvalRequestBtn_OBJ"><%-- 결제요청 --%>
                <spring:message code="M03044" />
            </button>
            <button class="btn btn-sm" id="cpnPointBtn" objCode="cpnPointBtn_OBJ"><%-- 쿠폰/포인트 발급 --%>
                <spring:message code="M03079" />
            </button>
...
<div id="approvalPop" class="popup_container"></div>
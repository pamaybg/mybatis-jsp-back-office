    ...
    var jqGridOption = {
        onSelectRow : function (data) {
            ...
            if (data.campaignTypeCode == 'QUICK') {
                ...
                //진행현황 활성
                getCampaignStatusList(data.id);
            }
            getAppIdAndInitSDK(data.id);
        },
...
function setLoadAndGoCampaignExecution() {
    var data = campaignListGrid.getCheckedList()[0];
    var id = data.id;
...
function campaignListSearchInit() {
    $.fn.ifvmSetCommonCondList("campaignSearchList", "MKTMNG001");
}

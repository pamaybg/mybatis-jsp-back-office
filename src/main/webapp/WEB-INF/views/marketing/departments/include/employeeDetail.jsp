...
<div class="page_btn_area">
	...
	<div class="col-sm-5 searchbtn_r">
		<button class="btn btn-sm" id="btnSave"> <i class="glyphicon glyphicon-check" objCode="EmployeeDetailAdd_OBJ"></i>
...
<div class="well underline form-horizontal" id="formArea">
	...
	<div class="row">
		...
		<div class="col-xs-4 control_content">
			<div>
				<ifvm:input type="text" className="form-control" dto="mobileNo" maxLength="11"/>

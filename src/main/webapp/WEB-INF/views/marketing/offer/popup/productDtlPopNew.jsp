...
function initProductDtlPopData(data) {
    ...
    $("#productDtlPopWrap").dataSetting(data);
...
<div id="productDtlPopWrap">
	<div class="pop_inner_wrap form-horizontal" id="productDtlPop" >
		...
		<div class="row qt_border" id="prodArea">
            ...
            <%-- 상품명 --%>
            <ifvm:inputNew type="search" id="prodNm|refKeySearch"
	        	hidId="ridProd" hidDto="ridProd" btnFunc="productListPopupOpen"
	        	dto="prodNm" names="prodNm" label="L00305" labelClass="3" conClass="9" />
            <ifvm:inputNew type="hidden" id="prodId" dto="prodId"/>
        ...
        <div class="row qt_border">
            ...
            <%-- POS 제품수량 --%>
            <ifvm:inputNew type="text" id="posProdCnt" dto="posProdCnt" label="M02285" labelClass="3" conClass="9" maxLength="32"/>
        </div>
        <div class="row qt_border">

            <%-- POS 제품코드 --%>
            <ifvm:inputNew type="text" id="posProdCd" dto="posProdCd" label="M02286" labelClass="3" conClass="9" maxLength="32"/>
        </div>
        <div class="row qt_border">

            <%-- POS 바코드번호 --%>
            <ifvm:inputNew type="text" id="posBcodeNo" dto="posBcodeNo" label="M02287" labelClass="3" conClass="9" maxLength="32"/>
        </div>
        <div class="row qt_border">

            <%-- POS 원가 --%>
            <ifvm:inputNew type="text" id="posProdAmt" dto="posProdAmt" label="M02442" labelClass="3" conClass="9" valiItem="number" />
        </div>
        <div class="row qt_border">

            <%-- POS 공급업체코드 --%>
            <ifvm:inputNew type="text" id="posProdAmt" dto="posProdAmt" label="M02443" labelClass="3" conClass="9" maxLength="32"/>
        </div>
	</div>
	<div class="pop_btn_area">
		<ifvm:inputNew type="button" btnFunc="productAdd" text="M01855" />
		<ifvm:inputNew type="button" btnFunc="productDtlPopClose" text="M00441" />
	</div>
</div>

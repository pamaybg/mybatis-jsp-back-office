...
function snSdetailCheck(){
	...
	if(chilId == "null"){
		...
		initSnsSetting();
		//$('#snsPageId').attr("disabled","disabled");
	}
}
...
// 			snsAdditionalInfoGrid.requestData( { mktChlId : rowid } );
			//idCheck();
...
<div id="capacityWrap">
	...
	<div class="pop_btn_area">
		<button class="btn btn-sm btn_gray" id="snsAdtnInfoSelectBtn">
			<i class="glyphicon glyphicon-check"></i>
			<spring:message code="M00280"/>
		</button> 
		<button class="btn btn-sm btn_lightGray2" id="snsAdtnInfoCancelBtn">         

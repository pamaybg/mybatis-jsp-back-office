...
//			userPopup(url); 
			...
			/* $.fn.ifvmPopupOpen('userModal',
					...
					'<ifvm:url name="userDetailPop"/>?empNo='+temp3+'&ridUser='+user.rid+'&id='+temp2.id
							,'<spring:message code="M01911"/>',860);	 */ 
//		}, 
		serializeGridData : function( data ){
			data.empId = empId;
			return data;
...
<div class="page_btn_area" id="userListArea">
	...
	<div class="col-sm-5 searchbtn_r">
		...
		<ifvm:inputNew type="button" id="modifyUser"  text="M00283" btnFunc="modifyUser()"/>
...
<div class="page_btn_area" id="ipAccessControlListArea">
	...
	<div class="col-sm-5 searchbtn_r">
		...
		<ifvm:inputNew type="button" id="modifyAcessControl"  	 text="M00283" btnFunc="clickModifyIpAccessControl()"/>

...
function getTargetGroupColumnList(){
    ...
    //타겟그룹 대상자 컬럼 목록 조회
    $.ifvSyncPostJSON('<ifvm:action name="getTargetGroupColumnAllList"/>', {
    ...
    var jqGridOption = {
            ...
            colModel:[
                { name:'displayName', index:'displayName', resizable : false, align:'center'},
            ],
            multiselect: true,
            tempId : 'ifvGridOriginNoneTemplete',
            rowList : [100000],
    };
...
function saveTargetGroupColumn() {
    ...
    function(result) {
        ...
        //팝업 닫기
        targetGroupColumnSetPopupClose();
    });
}
...
<div id="targetGroupColumnSetPopupWrap">
	...
	<div class="pop_btn_area">
	    <button class="btn btn-sm btn_gray" id="targetGroupColumnSetPopAddBtn" objCode="targetGroupColumnSetPopAddBtn_OBJ">
	        <i class="glyphicon glyphicon-check"></i>
	        <spring:message code="M00804"/>
	    </button> 
	    <button class="btn btn-sm btn_lightGray2" id="targetGroupColumnSetPopCloseBtn" objCode="targetGroupColumnSetPopCloseBtn_OBJ">         

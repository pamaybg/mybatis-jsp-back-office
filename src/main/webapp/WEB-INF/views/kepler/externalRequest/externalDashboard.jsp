...
<div class="page_btn_area" id="dashboardData">
	...
	<div class="col-xs-5 searchbtn_r">
		<button class="btn btn-sm" id="dashboardExecute"><spring:message code="M00603" /></button>
	</div>
</div>
...
<div class="well form-horizontal well_bt5">
	...
	<div class="row qt_border">
		<div class="col-xs-12">
			...
			<div class="col-xs-10" id="analyslsListArea">
			</div>
		</div>
	</div>
</div>
...
<div class="dashboard_area">
	<div class="dashboard_box_type1">
		<div class="header_chart">
			...
			<span class="icon_area" id="analysisSetting">
				<i class="fa fa-cog"></i>
			</span>
		</div>
...
<script type="text/javascript">
	...
	var getDashboardId = function() {
		...
		var startIdx = href.indexOf(target);
		var endIdx = href.indexOf('?');

		startIdx += target.length;
		dashboardId = href.substring(startIdx, endIdx);

...
<script type="text/javascript">
	...
	var getAnalysisColumnDetail = function( columnId ) {
	...
	var setAnalysisColumnSave = function() {
		...
		$.ifvPostJSON( "<ifv:action name='editAnalysisColumnDetail' />"
			, targetObj
			, function( rst ) {
			...
			$( "#" + ANALYSIS_CONFIG.POPUP_ID.ANALYSIS_COLUMN_POP ).data( "ejDialog" ).close();
		}, function( rst ) {
			$.ifvProgressControl(false);
			alert( rst.message );
		});
	...
	$( document ).ready(function() {
		...
		$.ifvSyncPostJSON( "<ifv:action name='getAnalysisAtribGroupColumnList' />", {
			...
			var tmpl = $( "#analysisAtribGroupColumnTemplate" ).tmpl( rst );
...
<div class="pop_inner_wrap">
	<div class="row qt_border">
		<label class="radio-inline">
			<ifv:input type="radio" names="calcFieldTypeCode" values="N" checked="true" id="calcFieldTypeCode" />
			<spring:message code="M01902" />
		</label>
		<label class="radio-inline">
			<ifv:input type="radio" names="calcFieldTypeCode" values="Y" id="calcFieldTypeCode" />
			<spring:message code="M01903" />
		</label>
	</div>
...
<div class="pop_btn_area">
	...
	<button class="btn btn-sm btn_lightGray2" id="analysisColumnCancelBtn"><spring:message code="C00040" /></button>
</div>
...
<script id="analysisAtribGroupColumnTemplate" type="text/x-jquery-tmpl">

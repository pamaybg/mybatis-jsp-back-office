...
function dbInformListInit(){
	var jqGridOption = {
	    ...
	    colModel:[{name:'serviceNm', index:'d.service_nm', resizable : false},
	              {name:'conDbTypeName', index:'c.mark_name', resizable : false},
...
$(document).ready(function(){
	...
	$("#databaseSchemaAdd").click(function(evt) {
		var checkedList = dbInformList.getCheckedGridData();
...
<div class="page_btn_area">
	...
	<div class="col-xs-5 searchbtn_r">
		<button class="btn btn-sm" id="databaseSchemaAdd">

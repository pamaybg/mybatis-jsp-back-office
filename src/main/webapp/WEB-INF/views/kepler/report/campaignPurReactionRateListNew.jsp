          ...
          summaryRows: [
        	   {
              	 title: "평균:",
                   summaryColumns: [
                       { summaryType: ej.Grid.SummaryType.Average, displayColumn: "purCnt"  , dataMember: "purCnt", format: "{0:n0}" }
                      ,{ summaryType: ej.Grid.SummaryType.Average, displayColumn: "rcptCnt"  , dataMember: "rcptCnt", format: "{0:n0}" }
                      ,{ summaryType: ej.Grid.SummaryType.Average, displayColumn: "txnAmt" , dataMember: "txnAmt", format: "{0:n0}" }
                      ,{ summaryType: ej.Grid.SummaryType.Average, displayColumn: "amtRcptCnt" , dataMember: "txnAmt", format: "{0:n0}" }
                      ,{ summaryType: ej.Grid.SummaryType.Average, displayColumn: "amtPurCnt" , dataMember: "amtPurCnt", format: "{0:n0}" }
                   ]  
              },
              {
              	 title: "합계:",
                   summaryColumns: [
                       { summaryType: ej.Grid.SummaryType.Sum, displayColumn: "purCnt"  ,  dataMember: "purCnt",   format: "{0:n0}" }
                      ,{ summaryType: ej.Grid.SummaryType.Sum, displayColumn: "rcptCnt"  , dataMember: "rcptCnt",  format: "{0:n0}" }
                      ,{ summaryType: ej.Grid.SummaryType.Sum, displayColumn: "txnAmt" ,   dataMember: "txnAmt",   format: "{0:n0}" }
                      ,{ summaryType: ej.Grid.SummaryType.Sum, displayColumn: "amtRcptCnt",dataMember: "txnAmt",   format: "{0:n0}" }
                      ,{ summaryType: ej.Grid.SummaryType.Sum, displayColumn: "amtPurCnt" ,dataMember: "amtPurCnt",format: "{0:n0}" }
                   ]   
              }
           ],
        dataUrl : '<ifvm:action name="getPurReactionInfoList"/>',
        columns:[ 
             {
                 field : 'yyyyMmDd' ,headerText : '구매일자', headerTextAlign : 'center', textAlign: 'center',
                 customAttributes : {
                    index : 'yyyyMmDd' , sortable: false}/*  */
              },{
                 field : 'purCnt' ,headerText : '구매고객수', headerTextAlign : 'center', textAlign: 'center',format : '{0:n0}',
                 customAttributes : {
                    index : 'purCnt' , sortable: false}/*  */
              },{
                 field : 'rcptCnt', headerText : '영수증 건수', headerTextAlign : 'center', textAlign: 'right', format : '{0:n0}',
                 customAttributes : {
                    index : 'rcptCnt' , sortable: false}/* */
              },{
                  field : 'txnAmt', headerText : '총 구매금액', headerTextAlign : 'center', textAlign: 'right', format : '{0:n0}',
                  customAttributes : {
                     index : 'txnAmt' , sortable: false}/* */
              },{
                  field : 'amtRcptCnt', headerText : '건단가', headerTextAlign : 'center', textAlign: 'right', format : '{0:n0}',
                  customAttributes : {
                     index : 'amtRcptCnt' , sortable: false}/* */
              },{
                  field : 'amtPurCnt', headerText : '객단가', headerTextAlign : 'center', textAlign: 'right', format : '{0:n0}',
                  customAttributes : {
                     index : 'amtPurCnt' , sortable: false}/* */
              }
        ],
        requestGridData : {
              nd   : new Date().getTime(),
        ...
        columns:[ 
             {
                 ...
                 field : 'recvCnt' ,headerText : '수신고객수', headerTextAlign : 'center', textAlign: 'center',format : '{0:n0}',
                 customAttributes : {
...
function excelExport() {
   $.ifvExcelDnMultiSheet('/kepler/report/getSendCampaignPurReactionExeDown.do',['sendCampaignDetailGrid','campaignDetailGrid']);
}
...
<div>
    <div class="page_btn_area">
        ...
        <div class="col-xs-5 searchbtn_r">
            <button class="btn btn-sm" id="reportSearchBtn" objCode="camPurReactionRateReportSearchBtn_OBJ"><i class="fa fa-search"></i>
                <spring:message code="M00135" />
            </button> 
            <button class="btn btn-sm" id="reportSearchInitBtn" objCode="camPurReactionRateReportInitBtn_OBJ">
...
<div>
    <div class="page_btn_area" id =''>
        ...
        <div class="col-xs-5 searchbtn_r">
            <button class="btn btn-sm" id="excelExportBtn" objCode="camPurReactionRateExcelExportBtn_OBJ">

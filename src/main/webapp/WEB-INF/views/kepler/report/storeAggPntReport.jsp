...
<div>
    <div class="page_btn_area">
        ...
        <div class="col-xs-5 searchbtn_r">
            <button class="btn btn-sm" id="reportSearchBtn" objCode="storeAggPntSearch_OBJ"><i class="fa fa-search"></i>
                <spring:message code="M00135" />
            </button>
            <button class="btn btn-sm" id="reportSearchInitBtn" objCode="storeAggPntSearchInit_OBJ">
		...
		<div class="row qt_border">
			<ifvm:inputNew type="dateTerm" startDto="startDt" endDto="endDt" startId="startDt" endId="endDt" label="검색기간" labelClass="1" conClass="4"/> 
		     <ifvm:inputNew type="checkBox" id="ofrCtg" label="임직원복리후생 제외" labelClass="1" conClass="1"/>
		 </div>
	 </div>
</div>
...
<div>
    <div class="page_btn_area" >
        ...
        <div class="col-xs-5 searchbtn_r">
            <button class="btn btn-sm" id="excelExportBtn" objCode="storeAggPntExcel_OBJ">
...
function getCustomSummaryOnline(){
	  sumobj = {};
	$.ifvSyncPostJSON('<ifvm:action name="getStoreAggPntReport2"/>',{
		startDt : $("#startDt").val().replace(/-/g,""),
		endDt : $("#endDt").val().replace(/-/g,""),
	    ofrCtg : $("#ofrCtg").is(':checked') ? 'y' : '',
		chnlTypeCd : "M"
	},
	function(result) {
...
function empAggPntGridList(){
    var ejGridOption = {
           serializeGridData : function(data) {
                ...
                data.ofrCtg =$("#ofrCtg").is(':checked') ? 'y' : '';
                return data;
             },  
           ...
           dataUrl : '<ifvm:action name="getStoreAggPntReport"/>',
             columns:[
            	 {
...
$(document).ready(function() {
 ...
 $("#excelExportBtn").on('click', function() {
      	$.ifvExcelDn('/kepler/report/storeAggPntReportExcel.do','empAggPntGrid' );
    });

...
//         	  var reportSearchObj = $('#reportSearchCondition').getSubmitData();
          ...
          dataUrl : '<ifvm:action name="daysSalseList"/>',
        columns:[
             {
                 field : 'days' ,headerText : '일자', headerTextAlign : 'center', textAlign: 'center',
                 customAttributes : {
                    index : 'num' , sortable: false}/*  */
              },{
                 field : 'buyMbr' ,headerText : '구매회원수', headerTextAlign : 'center', textAlign: 'right',format : '{0:n0}',
                 customAttributes : {
        ...
        stackedHeaderRows: [{
            stackedHeaderColumns:[
               { headerText: "활성 회원 기준"      , column: "buyMbr, rciptCnt, salAmt,buyCnt,rciptAmt" ,headerTextAlign : "center" },
                { headerText: "멤버십 형태별 구매 회원수", column: "membership,sotreMbr,mbrWp,wdMemCnt" ,  headerTextAlign : "center" },
    ...
    daysMbrGrid = $("#daysMbrGrid").ifvsfGrid({ ejGridOption : ejGridOption });
}
...
function excelExport() {
   $.ifvExcelDn('/kepler/report/daysSalseExport.do','daysMbrGrid');
}
...
<div>
    ...
    <div id="daysMbrGrid" class="white_bg grid_bd0"></div>
</div>

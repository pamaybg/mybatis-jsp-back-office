...
function getLogicalComponentListGrid(){
    ...
    var ejGridOption = {
        ...
        columns:[ 
        	{
	      		  ...
	      		  field : 'logicalCompDesc', headerText : '<spring:message code="로지컬컴포넌트 설명"/>', headerTextAlign : 'center', width: "350px",
	      		  customAttributes : {
	      			  index : 'l.LGC_DESC',
	      				searchable: true}
	      	  },{
	      		  ...
	      		  field : 'createDate', headerText : '<spring:message code="등록일자"/>', headerTextAlign : 'center', width: "160px", textAlign : ej.TextAlign.Center,
	      		  customAttributes : {
	      			  index : 'l.CREATE_DATE' }
	      	  },{
        ...
        radio: true,
        rowList : [15,50,100],  // 한 번에 출력될 데이터row의 갯수 설정(50개)
        rowNum: 15,
  	...
  	if (segmentNewPopValidation.confirm()) {
        ...
        if ($.fn.ifvmIsNotEmpty(logicalComponentListGrid.opt.gridControl.getSelectedRecords())) {
            ...
            , function(result) {
                ...
                //세그먼트 상세 화면 이동
                var url = '<ifvm:url name="segmentDetail_KPR"/>';

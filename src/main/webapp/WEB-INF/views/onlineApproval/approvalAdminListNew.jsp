    ...
    var ejGridOption = {
      ...
      approvalAdminDetailDtlPop();   // 상세 보기 이벤트
       ...
       serializeGridData : function( data ){
        ...
        columns: [
        	{
        		field: 'elecAprvType', headerText: '<spring:message code="L01593"/>',
        		customAttributes: {
        			index: 'elecAprvTypeCd'
        		}
        	}, {
...
<div>
    <div class="page_btn_area" >
        ...
        <ifvm:inputNew type="button" btnType="plus" text="I00080" id="approvalAdminNewBtn"  btnFunc="fnApprovalAdminNew" objCode="approvalAdminListNewAdd_OBJ"/>
        <ifvm:inputNew type="button" btnType="delete" text="L00029" id="approvalAdminRemoveBtn"  btnFunc="fnApprovalAdminRemove" objCode="approvalAdminListNewRemove_OBJ"/>

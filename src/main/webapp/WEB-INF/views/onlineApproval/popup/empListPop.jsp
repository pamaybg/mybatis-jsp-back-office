...
<div id="empPopupCon">
	...
	<div class="pop_btn_area">
	    <button class="btn btn-sm btn_gray" id="empListPopSaveBtn" objCode="empListPopSaveBtn_OBJ">
	        <i class="glyphicon glyphicon-check"></i>
	        <spring:message code="M00282"/>
	    </button> 
	    <button class="btn btn-sm btn_lightGray2" id="empListPopCancelBtn" objCode="empListPopCancelBtn_OBJ">

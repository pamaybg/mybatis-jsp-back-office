...
%>
<script>
    var apId = '<%= cleanXss(request.getParameter("aprvId")) %>';

    function editReject() {
        // language code

        var active = 0;
//     var checkedList = campaignListGrid.getCheckedList();
    ...
    <div class="pop_inner_wrap form-horizontal">
        <div class="row">
            ...
            <div class="col-xs-9 control_content">
                <ifvm:input type="textarea" className="text_description text_description_150" id="description" />
            </div>
        </div>
    </div>
    <div class="pop_btn_area">
        <button class="btn btn-sm btn_gray" id="saveBtn" objCode="rejectPopSave_OBJ">
            <i class="glyphicon glyphicon-check"></i>
            <spring:message code="M00280"/>
        </button>
        <button class="btn btn-sm btn_lightGray2" id="refusalCancelBtn" objCode="rejectPopCancel_OBJ">

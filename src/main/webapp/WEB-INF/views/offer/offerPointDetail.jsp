...
<script id="offerPointTemp" type="text/x-jquery-tmpl">
	...
	var OfferDetail = function (rid) {
	    ...
	    this.formDataLoad = function () {
	        var _callback = function (result) {
	            if ($.fn.ifvmIsNotEmpty(result)) {
	                ...
	                $("#ofrType option[value='D']").remove();
		            $("#ofrType option[value='G']").remove();
	    ...
	    this.setButtons = function () {
	        ...
	        $("#btnList").click(function () {
	            qtjs.href('<ifvm:url name="offerPointList"/>');
	        });
			
	    },
	    /* 메뉴 세팅 */
	    this.setMenu = function () {
	        $.ifvmLnbSetting('offerPointList');
	    },
	    /* Form 데이터 제출 */
	    this.onSubmit = function () {
	        ...
	        var _afterSubmit = function (result) {
	            ...
	            if (this.isNew)  {
	                qtjs.href('<ifvm:url name="offerPointDetail"/>'+ '?rid=' + resultRid  );
	            }
	        };
			...
			<div class="row ">
				<div class="col-xs-6">
					...
					<ifvm:inputNew type="select" id="ofrType" names="ofrType" label="O00019" labelClass="2" conClass="8" required="true"/>
			         ...
			         <!-- 관리/연계 코드 -->
               <div class="col-xs-6">
                    <ifvm:inputNew type="select" id="refCd" names="refCd" label="관리코드" labelClass="2" conClass="8" />
               </div>
			   <div class="col-xs-6">
				     <!-- 소유형 -->
				...
				<!-- 쿠폰형 -->
                           <div class="col-xs-6">
                                <ifvm:inputNew type="checkBox" id="cpnYn" disabled="true" label="O00023" labelClass="4" conClass="3" />

    ...
    <div class="form-horizontal underline top_well"  >
        <div class="row qt_border" >
            ...
            <div class="col-xs-12">
                ...
                <!-- 찾아보기 버튼 -->
                <ifvm:inputNew type="button" text="L01671"  id="fileSearchBtn" btnFunc="fileSearchFn" objCode="ofrJoinProdUploadFileSearch_OBJ"/>
            </div>
        </div>
...
<div class="pop_btn_area">
    <!-- 저장 버튼 -->
    <ifvm:inputNew type="button" btnType="upload" text="M00137" id="uploadBtn" btnFunc="fnUploadsave" objCode="ofrJoinProdUploadSave_OBJ"/> <!--  objCode="faqUploaduploadBtn_OBJ" -->
    <!-- 닫기 버튼 -->
    <ifvm:inputNew type="button" btnType="cancel" text="I00404" btnFunc="fnClose" objCode="ofrJoinProdUploadClose_OBJ"/> <!--  objCode="faqUploadclose_OBJ" -->
</div>

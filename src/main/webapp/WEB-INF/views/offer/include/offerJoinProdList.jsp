...
<script type="text/javascript">
        ...
        this.setRid = function (rid) {
            ...
            this.setGridAndDataLoad = function (url) {
                ...
                var ejGridOption = {
                    ...
                    dataUrl: '<ifvm:action name="getOfferJoinProdList"/>',
            ...
            this.openPopup = function () {
                $.fn.ifvmPopupOpen('popupContainer', this.getRid(),
                    '<ifvm:url name="offerLoyProdListPopup"/>',
            ...
            this.removeAction = function (obj) {
                ...
                if (selectId == "btnRemoveOfferJoinProd") {
                    ...
                    _url = '<ifvm:action name="removeOfferJoinAllProd"/>';
                }
    ...
    function targetListDownload() {
        if (joinChnlGrid.opt.gridControl.model.dataSource.length != 0) {
            $.ifvExcelDn('<ifvm:action name="exportExcelOfferJoinProdTargetList"/>', 'joinProdGrid');
        } else {
    ...
    function excelDownChnlItem() {
        $("#chnlExcelUploadPop").ifvsfPopup({
            enableModal: true,
            enableResize: false,
            contentUrl: '<ifvm:url name="offerJoinProdExcelPop"/>',
            contentType: "ajax",
            title: '상품 업로드',
            width: 600,
...
<div class="page_btn_area">
    <div class="col-xs-7">
        <span><spring:message code="사용가능 상품"/></span>
    </div>

...
<div id="pop_main_div">
	...
	<div class="pop_btn_area">
	    <button class="btn btn-sm btn_gray" id="DeleteSelectBtn" objCode="employeeDeleteBtn_OBJ">
	        <i class="glyphicon glyphicon-check"></i>
			<spring:message code="M01854"/>
	    </button> 
	    <button class="btn btn-sm btn_lightGray2" id="DeleteCancelBtn" objCode="employeeDeleteCancelBtn_OBJ">

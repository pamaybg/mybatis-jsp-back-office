...
var authGroupModal = null;
var loyPgmModal = null;
var userModal = null;
var beforeDeleteModal = null;
var setIpAcesCtrl = null;
var ipAcesCtrlHist = null;
var loginHistPop = null;
var data;
var employeeId = null;
...
function clickInsertEmployee(){
	...
	//직원 신규
	qtjs.href('<ifvm:url name="employeeDetailUrl2"/>' + '?ridDivision=' + ridDivision);
}

function beforeDeleteEmployee(){
	$('#beforeDeleteModal').ifvsfPopup({
		enableModal : true,
	    enableResize: false,
...
function authGroupList(rid, empId){
	...
	var ejGridOption = {
        ...
        columns:[
        	{
        		  field : 'authGroupName', headerText : '<spring:message code="M01243"/>', customAttributes: { searchable: true , index : " ag.aut_group_nm"}
        	  },{
          		  field : 'authGroupDesc', headerText : '<spring:message code="M01264"/>'
          	  },{
          		  field : 'modifyDate', headerText : '<spring:message code="M01846"/>'
          	  },{
...
function userList(empId){
	...
	var ejGridOption = {
        ...
        columns:[
        	 {
         		  field : 'userId', headerText : '<spring:message code="M00193"/>' , customAttributes: { searchable: true , index : "cu.user_id"}
         	  }, {
          		  field : 'pwExpireDate', headerText : '<spring:message code="M01906"/>'
          	  }, {
          		  field : 'userPwCnt', headerText : '<spring:message code="V00169"/>'
          	  }, {
          		  field : 'acesStartDate', headerText : '<spring:message code="V00300"/>'
          	  }, {
          		  field : 'acesEndDate', headerText : '<spring:message code="V00301"/>'
          	  }, {
...
function employeeList(divId){
	var storeId = $('#storeId').val() == "" ? null :$('#storeId').val();
	...
	var ejGridOption = {
        ...
        columns:[
        	{
       		  field : 'storeName', headerText : '<spring:message code="M00558"/>' , customAttributes: { searchable: true , index : "T.storename"}, textAlign : 'center'
       	  },{
     		  field : 'employeeNo', headerText : '<spring:message code="M00562"/>' , customAttributes: { searchable: true, index : "T.employeeno"}, textAlign : 'center'
     	  },{
     		  field : 'employeeName', headerText : '<spring:message code="M00007"/>',customAttributes: { searchable: true, index : "T.employeename"}
     	  },{
     		  field : 'position', headerText : '<spring:message code="M00563"/>',customAttributes: { index : "T.position"}, textAlign : 'center'
     	  },{
     		  field : 'responsibility', headerText : '<spring:message code="M00564"/>',customAttributes: { index : "T.responsibility"}, textAlign : 'center'
     	  },{
			  field: 'employeeTypeNm', headerText: '<spring:message code="시용자 유형"/>', customAttributes: {index: "T.employeeType"}, textAlign : 'center'
		  },{
			  field: 'xAuthTypeNm', headerText: '<spring:message code="권한 유형"/>', customAttributes: {index: "T.xAuthType"}, textAlign : 'center'
		  },{
     		  field : 'workStatus', headerText : '<spring:message code="M00565"/>',customAttributes: { index : "T.workstatus"}, textAlign : 'center'
     	  },{
     		  field : 'id', headerText : 'id', visible : false
     	  },
        ],
...
function ipAccessControlList(rid){
	...
	var ejGridOption = {
		...
		columns:[
        	  {
        		  field : 'accessIpAddr', headerText : '<spring:message code="V00160"/>', customAttributes: { searchable: true , index : " a.access_ip_addr"}
        	  },{
          		  field : 'aclTypeCd', headerText : '<spring:message code="V00161"/>'
          	  },{
          		  field : 'useYnCd', headerText : '<spring:message code="V00162"/>'
          	  },{
...
function storeListModalSelected(obj) {
	...
	$('#storeId').val(obj.rid);
	//employeeListCon.searchGrid({ storeId : obj.rid, storeType : obj.storeType });
...
function authGroupPopupClose(){
	authGroupModal._destroy();
}

function loyPgmPopupClose(){
	loyPgmModal._destroy();
}
...
function deleteUser(){
	...
	if(userData != null){
		...
		alert('<spring:message code="M01265"/>');
	}
}
...
$(document).ready(function() {
	...
	enableModal : true,
		...
		$('#employeeListSearchInitBtn').click(function() {
			storeListModalSelected('null');
		});
...
<div>
	<div class="page_btn_area">
		...
		<div class="col-sm-5 searchbtn_r">
			<button class="btn btn-sm" id='employeeListSearchBtn' objCode="employeeListSearchBtn_OBJ"><i class="fa fa-search"></i>
				<spring:message code="M00135" />
			</button>
			<button class="btn btn-sm" id='employeeListSearchInitBtn' objCode="employeeListSearchInitBtn_OBJ">
				<spring:message code="초기화" />
			</button>
		</div>
	</div>
	...
	<div class="well">
		...
		<div class="row">
			<label class="col-sm-2 control-label"><span class="asterisk">*</span><spring:message code="M00558"/></label>
			<div class="col-sm-3 control_content">
				<div class="input-group" style="width:100%;">
				<ifvm:input type="text" className="form-control" id="storeName" />
				<ifvm:input type="hidden" className="form-control" id="storeId" />
...
<div>
	<div class="page_btn_area">
		...
		<div class="col-sm-5 searchbtn_r">
			<ifvm:inputNew type="button" id="insertEmployee"  text="M00571" btnType="plus" btnFunc="clickInsertEmployee" objCode="insertEmployeeNew_OBJ"/>
			<ifvm:inputNew type="button" id="modifyEmployee"  text="M00283" btnFunc="modifyEmployee()" objCode="modifyEmployeeNew_OBJ"/>
			<ifvm:inputNew type="button" id="deleteEmployee"  text="M00572" btnType="minus" objCode="deleteEmployeeNew_OBJ"/>
		</div>
	</div>
...
<div>
	<div class="page_btn_area" id="userListArea">
		...
		<div class="col-sm-5 searchbtn_r">
			<ifvm:inputNew type="button" id="showLoginHistPop"  text="M02159" btnType="" btnFunc="clickShowLoginHistPop" objCode="departmentShowLogin_OBJ"/>
			<ifvm:inputNew type="button" id="insertUser"  text="M00571" btnType="plus" btnFunc="clickInsertUser" objCode="departmentInsertUser_OBJ"/>
			<ifvm:inputNew type="button" id="modifyUser"  text="M00283" btnFunc="modifyUser()" objCode="departmentModifyUser_OBJ"/>
			<ifvm:inputNew type="button" id="deleteUser"  text="M00572" btnType="minus" btnFunc="clickDeleteUser" objCode="departmentDeleteUser_OBJ"/>
		</div>
	</div>
...
<div>
	<div class="page_btn_area" id="authGroupListArea">
		...
		<div class="col-sm-5 searchbtn_r">
			<ifvm:inputNew type="button" id="insertAuthGroup"  text="M00571" btnType="plus" btnFunc="clickInsertAuthGroup" objCode="departmentInsertAuthGroup_OBJ"/>
			<ifvm:inputNew type="button" id="deleteAuthGroup"  text="M00572" btnType="minus" btnFunc="clickDeleteAuthGroup" objCode="departmentDelAuthGroup_OBJ"/>
		</div>
	</div>
...
<div>
	<div class="page_btn_area" id="ipAccessControlListArea">
		...
		<div class="col-sm-5 searchbtn_r">
			<ifvm:inputNew type="button" id="setIpAcesCtrlPop"  	 text="V00163" btnType="" btnFunc="showIpAcesCtrlHistPop" objCode="departmentShowIpAces_OBJ"/>
			<ifvm:inputNew type="button" id="insertIpAccessControl"  text="M00571" btnType="plus" btnFunc="clickInsertIpAccessControl" objCode="departmentInsertIpAces_OBJ"/>
			<ifvm:inputNew type="button" id="modifyAcessControl"  	 text="M00283" btnFunc="clickModifyIpAccessControl()" objCode="departmentModifyIpAces_OBJ"/>
			<ifvm:inputNew type="button" id="deleteIpAccessControl"  text="M00572" btnType="minus" btnFunc="clickDeleteIpAccessControl" objCode="departmentIpDelAces_OBJ"/>
		</div>
	</div>
...
<!-- 로그인 사용자 IP접근제어 팝업 -->
<div id="setIpAcesCtrl" class="popup_container"></div>
<!-- 로그인 사용자 IP접근제어 이력 팝업 -->
<div id="ipAcesCtrlHist" class="popup_container"></div>
<!-- 로그인 이력 -->
<div id="loginHistPop" class="popup_container"></div>
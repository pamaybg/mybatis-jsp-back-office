...
function initUserGrid() {
	...
	var ejGridOption = {
        ...
        columns:[
        	{
        		  field : 'userId', headerText : '<spring:message code="I02082"/>', textAlign : 'left', customAttributes : {searchable : true, index : 'u1.user_id'}
        	  },{
          		  field : 'empName', headerText : '<spring:message code="I02078"/>', textAlign : 'left', customAttributes : {searchable : true, index : 'e.name'}
          	  },{
          		  field : 'empTypeCd', headerText : '<spring:message code="I02079"/>', textAlign : 'center'
          	  },{
          		  field : 'empCreater', headerText : '<spring:message code="I02055"/>', textAlign : 'left',
          	  },{
          		  field : 'empCreateDate', headerText : '<spring:message code="I02056"/>', textAlign : 'center',
          	  },{

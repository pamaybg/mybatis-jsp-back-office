...
function initAuthGrid() {
	...
	var ejGridOption = {
		...
		columns:[
        	{
        		  field : 'authName', headerText : '<spring:message code="I02060"/>', headerTextAlign : 'center', customAttributes : {searchable : true, index : 'at.aut_nm'}
        	  },{
          		  field : 'authDesc', headerText : '<spring:message code="I00075"/>', headerTextAlign : 'center', customAttributes : {searchable : true, index : 'at.aut_desc'}
          	  },{
...
function addAuthDetail() {
	if (groupId != null && groupId != "null") {
		...
		$("#popupContainer").ifvsfPopup({
	        enableModal : true,
	        enableResize : false,
	        contentUrl : '<ifvm:url name="authAddListPop"/>',
	        contentType : "ajax",
	        title : "<spring:message code="권한 그룹"/>",
	        width : '860px',

		...
		if(validation.confirm()){
			if(apiParamReqRid != null){
				...
				,function(result) {
					...
					$.fn.ifvmPopupClose();
					ifvGlobal.apiParamNew.setGridDataLoad();
				});
			} else {
...
*/
$(function(){
	$.fn.ifvmSetSelectOptionCommCode("paramTypeCd", "API_PARAM_TYPE_CD", "REQ", null, true);
	...
	if(apiParamReqRid != null) {
		//이벤트 조회
		$.ifvSyncPostJSON('<ifvm:action name="getParamReqDetail"/>', {
			rid : apiParamReqRid
		}, function(result) {
...
<div class="form-horizontal underline top_well" id='apiParamReqForm'>
	<div class="pop_inner_wrap form-horizontal">
	    <div class="row qt_border">
	        ...
	        <div class="col-xs-4 control_content">
	            <ifvm:input type="select" names="paramSubTypeCd" dto="paramSubTypeCd" id="paramSubTypeCd" required="true" />
	        </div>
	    </div>

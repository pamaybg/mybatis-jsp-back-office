...
<div id="capacityWrap">
	...
	<div class="pop_btn_area">
		<button class="btn btn-sm btn_gray" id="capacityChannelSelectBtn" objCode="capacityPerSelect_OBJ">
			<i class="glyphicon glyphicon-check"></i>
			<spring:message code="M00280"/>
		</button> 
		<button class="btn btn-sm btn_lightGray2" id="capacityChannelCancelBtn" objCode="capacityPerCancel_OBJ">         

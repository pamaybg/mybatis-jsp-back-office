...
function obj(){
	...
	var ajaxSettings = {
	    upload: { 
	    	url: "/common/uploadImageS3.do?imageType=" + conimagetype
	    },
	    download: {
	...
	var localServ = "/common/getFileS3.do";
    ...
    $("#fileExplorer").ejFileExplorer({
        ...
        layout: "list",
        path : '<ifvm:url name="imageViewS3"/>',
        select: "onSelect",
        remove : "onRemove",
        //open : "oOpen",
        ...
        beforeAjaxRequest: function (args) { args.data.imageType = conimagetype;},
    });
...
function isRestrictCrossOrigin () {
 ...
 function onRemove(args){
        $.ifvSyncPostJSON('<ifvm:action name="removeImageS3"/>', {
...
function onSelect(args) {
    if(args.selectedItems[0] != null)
    {
        ...
        $('#imgPath').val(args.selectedItems[0].imgPath + '/' + imgName);
        $('#filedate').val(date[0]);
...
function selectImage() {
    ...
    if(sizeCheck){
        ...
        $.ifvSyncPostJSON('/system/menu/updateMenuIcon.do',{
        	menuId : currMenuId, 
        	iconImg : _imgName
        }, function(result){ 
        	alert("아이콘이 적용되었습니다. 다시 로그인 하세요.");
        	$("#menuIcon").val(_imgName);
        });
...
<div class="">
    ...
    <div class="well form-horizontal well_sum fileexplorer_bg">
        <div class="row qt_border">
            ...
            <button class="inner_btn" objCode="showMenuIconInner_OBJ"><spring:message code="M00811"/></button>
            </div>
        </div>
        <div class="row">
...
<div class="pop_btn_area">
    <button class="btn btn-sm btn_gray" id="addImage" objCode="showMenuIconAddImage_OBJ">         
        <i class="glyphicon glyphicon-check"></i>
        <spring:message code="M00282"/>
    </button> 
    <button class="btn btn-sm btn_lightGray2" id="fileExplorerClose" objCode="showMenuIconClose_OBJ">         

...
function responseInfoSearchResultList(){
	var ejGridOption = {
	    ...
	    columns:[
	    	 {
       		  field : 'camRspnsCd', headerText : '<spring:message code="M01259"/>'
       	  }, {
    		  field : 'camRspnsNm', headerText : '<spring:message code="M01260"/>' , customAttributes : {searchable : true , index : 'mrim.cam_rspns_nm'}
    	  }, {
    		  field : 'spcfChnlRspnsCd', headerText : '<spring:message code="M01261"/>' , customAttributes : {index : 'spcfChnlRspnsTypeCd' }
    	  }, {
    		  field : 'dpSeq', headerText : '<spring:message code="M01262"/>',
    	  }, {
    		  field : 'parRspnsCd', headerText : '<spring:message code="M01263"/>',
    	  }, {
    		  field : 'camRspnsDesc', headerText : '<spring:message code="M01264"/>',
    	  }, {
...
<div>
	...
	<div class="well form-horizontal" id="responseRequiredList" ></div>
</div>
<div>
	<div class="page_btn_area">
		<div class="col-xs-7">

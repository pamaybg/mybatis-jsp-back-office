...
<div class="pop_btn_area">
	<!-- 저장 버튼 -->
	<ifvm:inputNew type="button" btnType="upload" text="M00137" id="uploadBtn" btnFunc="fnUploadsave" objCode="faqUploaduploadBtn_OBJ"/> <!--  objCode="faqUploaduploadBtn_OBJ" -->
	<!-- 닫기 버튼 -->
	<ifvm:inputNew type="button" btnType="cancel" text="I00404" btnFunc="fnClose" objCode="faqUploadclose_OBJ"/> <!--  objCode="faqUploadclose_OBJ" -->
</div>
...
function fileSearchFn() {
	fnExcelUpload({
		...
		url: '<ifvm:action name="uploadExcelRoadAddress"/>',
...
// 엑셀업로드 팝업창 닫기
function fnClose() {
	roadAddressExcelUploadPop.close(); // 도로명주소 엑셀업로드 팝업창 닫기
}

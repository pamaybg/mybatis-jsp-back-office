...
function programGridList() {
	var ejGridOption = {
			...
			dataUrl : '<ifvm:action name="getProgramChildTab"/>',
			columns:[
				{
...
$("#progRelExcelDown").on('click', function() {
	//DB에서 헤더 값 가져오기
  	$.ifvDBExcelDn('/system/program/progRelExcelDown.do', $("#progRelExcelDown").attr("objcode"));
});
...
<div class="page_btn_area">
	...
	<%-- <div class="col-sm-5 searchbtn_r">
		<ifvm:inputNew type="button" id="progRelExcelDown" text="M01218" objCode="progRelExcelDown_OBJ"/>
 		<ifvm:inputNew type="button"  id="addParProg"  text="I00887" btnType="plus" />
 		<ifvm:inputNew type="button"  id="delParProg"  text="I00888" btnType="minus"/>
	</div> --%>
</div>

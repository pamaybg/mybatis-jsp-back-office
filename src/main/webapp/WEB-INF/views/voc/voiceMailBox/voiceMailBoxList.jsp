	...
	var jqGridOption = {
		...
		loadComplete : function(data) {
			if(data.rows.length == 1){
				...
				selectRowAction(data.rows[0]);
			}
			parent.setParentIframeHeight();
		},
		url: '<ifvm:action name="getVoiceMailBoxList"/>',
	    colNames:[
	              '<spring:message code="V00105"/>', /* 전화인입일시 */
	              '<spring:message code="V00106"/>', /* 카드번호 */
	              '<spring:message code="V00107"/>', /* 전화번호 */
	              '<spring:message code="V00108"/>', /* 등록여부 */
	              '<spring:message code="V00109"/>', /* 등록일시 */
	              '<spring:message code="V00110"/>', /* 오류여부 */
	              '<spring:message code="V00111"/>', /* 오류구분 */
	              '<spring:message code="V00112"/>', /* 오류일시 */
	              'rid',
	              'callId',
	              'cardPwd',
	              'ridCust'
	    ...
	    colModel:[
	              {name:'telLdinDt',  			index:'a.tel_ldin_dt', 			resizable : false, 		align:'center',    	width:'100px',  		formatter:'datetime',  formatoptions:{newformat:"Y-m-d H:i:s"}},
	              {name:'cardNo', 				index:'a.card_no', 				resizable : false, 		align:'center',    	width:'100px'},
	              {name:'telNo', 				index:'a.tel_no', 				resizable : false, 		align:'center',    	width:'100px'},
	              {name:'regYn',     			index:'a.reg_yn', 				resizable : false, 		align:'center',    	width:'100px', 			formatter:regIsYn},
	              {name:'regDt', 				index:'a.reg_dt', 				resizable : false, 		align:'center',    	width:'100px',  		formatter:'datetime',  formatoptions:{newformat:"Y-m-d H:i:s"}},
	              {name:'errYn', 				index:'a.err_yn', 				resizable : false, 		align:'center',    	width:'100px', 			formatter:errIsYn},
	              {name:'errCd', 				index:'a.ERR_CD', 				resizable : false, 		align:'center',    	width:'100px'},
	              {name:'errDt', 				index:'a.err_dt', 				resizable : false, 		align:'center',    	width:'100px',  		formatter:'datetime',  formatoptions:{newformat:"Y-m-d H:i:s"}},
	              {name:'rid', 					index:'a.rid', 					resizable : false, 		hidden : true},
	              {name:'callId', 				index:'a.call_id', 				resizable : false, 		hidden : true},
	              {name:'cardPwd', 				index:'a.card_pwd',				resizable : false, 		hidden : true},
	              {name:'ridCust', 				index:'a.rid_cust',				resizable : false, 		hidden : true}
			      ],
		radio:true,
		sortname: 'a.tel_ldin_dt',
		sortorder: "desc",
// 		tempId : 'ifvGridExcelTemplete'
	};
	voiceMailBoxGrid = $("#voiceMailBoxListGrid").ifvGrid({ jqGridOption : jqGridOption });
}

...
function getCallList(){
	var ejGridOption = {
		...
		dataUrl: '<ifvm:action name="getCallList"/>',
		columns:[
			{
	      		  field : 'chnlType', headerText : '<spring:message code="L00132"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'b.mark_name' }
	      	  },{
	      		  field : 'svcType', headerText : '<spring:message code="V00076"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'c.mark_name' }
	      	  },{
	      		  field : 'cserCurTime', headerText : '<spring:message code="V00077"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'a.CSER_CUR_TIME' }
	      	  },{
	      		  field : 'custNm', headerText : '<spring:message code="L00320"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'd.cust_nm' }
	      	  },{
	      		  field : 'callId', headerText : '<spring:message code="V00029"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'a.CALL_ID' }
	      	  },{
	      		  field : 'rcpDt', headerText : '<spring:message code="V00078"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'a.CREATE_DATE' }
	      	  },{
	      		  field : 'telNo', headerText : '<spring:message code="L00400"/>', headerTextAlign : 'center',
	      		  customAttributes : {
	      			  index : 'a.TEL_NO' }
	      	  },{
...
// 		tempId : 'ifvGridExcelTemplete'
	...
	callGrid = $("#callListGrid").ifvsfGrid({ ejGridOption : ejGridOption });
}
...
function clickRecordBtn(){
	if(callGrid.opt.gridControl.getSelectedRecords()[0] != undefined){
...
function clickUnmaskBtn(){
	if(callGrid.opt.gridControl.getSelectedRecords()[0] != undefined){
	    ...
	    function(result) {
	    	var rowid = callGrid.opt.gridControl.getSelectedRows();

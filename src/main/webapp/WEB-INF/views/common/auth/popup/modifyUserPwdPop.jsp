...
<div class="well form-horizontal">
	...
	<div class="row">
		<div class="warning_box">※비밀번호 변경 주기는 <%=BeansUtil.getApplicationProperty("icignal.login.password.limit-day")%>일 입니다.</div>
	</div>
	<div class="row qt_border">
		<ifvm:inputNew type="button" id="saveBtn" text="L00074" btnFunc="clickSaveBtn" objCode="modifyUserPwdPopSaveBtn_OBJ"/>
		<ifvm:inputNew type="button" id="closeBtn" text="L00913" btnFunc="popupContainerClose" objCode="modifyUserPwdPopCloseBtn_OBJ"/>
	</div>
</div>
